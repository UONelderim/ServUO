...
namespace Server
{
	...
	public class SkillInfo
	{
		...
		{
			new SkillInfo(00, "Alchemia", 0.0, 5.0, 5.0, "Alchemik",           null, 0.00, 1.00, 1.00, 1.50, StatCode.Int, StatCode.Dex),
			new SkillInfo(01, "Anatomia", 0.0, 0.0, 0.0, "Anatom",             null, 2.00, 0.00, 2.00, 1.75, StatCode.Int, StatCode.Str),
			new SkillInfo(02, "Wiedza o Zwierzetach", 0.0, 0.0, 0.0, "Zoolog", null, 2.00, 0.00, 2.40, 1.75, StatCode.Int, StatCode.Str),
			new SkillInfo(03, "Identyfikacja", 0.0, 0.0, 0.0, "Rzeczoznawca",  null, 0.00, 0.00, 2.00, 3.00, StatCode.Int, StatCode.Dex),
			new SkillInfo(04, "Wiedza o broni", 0.0, 0.0, 0.0, "Zbrojmistrz",  null, 2.00, 0.00, 1.80, 1.00, StatCode.Int, StatCode.Str),
			new SkillInfo(05, "Parowanie", 7.5, 2.5, 0.0, "Obronca",           null, 1.50, 1.00, 0.00, 1.00, StatCode.Dex, StatCode.Str, true ),
			new SkillInfo(06, "Zebranie", 0.0, 0.0, 0.0, "Zebrak",             null, 0.00, 1.00, 1.00, 10.0, StatCode.Dex, StatCode.Int),
			new SkillInfo(07, "Kowalstwso", 10.0, 0.0, 0.0, "Kowal",           null, 3.00, 1.50, 0.00, 2.50, StatCode.Str, StatCode.Dex),
			new SkillInfo(08, "Wyrabianie Lukow", 6.0, 16.0, 0.0, "Luczarz",   null, 1.50, 3.00, 0.00, 2.50, StatCode.Dex, StatCode.Str),
			new SkillInfo(09, "Uspokajanie", 0.0, 0.0, 0.0, "Uspokajacz",      null, 0.00, 1.00, 1.50, 10.0, StatCode.Int, StatCode.Dex, true ),
			new SkillInfo(10, "Obozowanie", 20.0, 15.0, 15.0, "Podroznik",     null, 0.10, 0.50, 0.20, 1.00, StatCode.Dex, StatCode.Int),
			new SkillInfo(11, "Stolarstwo", 20.0, 5.0, 0.0, "Stolarz",         null, 0.00, 1.50, 1.00, 2.50, StatCode.Str, StatCode.Dex),
			new SkillInfo(12, "Kartografia", 0.0, 7.5, 7.5, "Kartograf",       null, 0.00, 1.00, 2.00, 2.50, StatCode.Int, StatCode.Dex),
			new SkillInfo(13, "Gotowanie", 0.0, 20.0, 30.0, "Szef kuchni",     null, 0.00, 6.00, 4.00, 2.00, StatCode.Int, StatCode.Dex),
			new SkillInfo(14, "Wykrywanie", 0.0, 0.0, 0.0, "Zwiadowca",        null, 0.00, 1.60, 1.00, 10.0, StatCode.Int, StatCode.Dex),
			new SkillInfo(15, "Dezorientacja", 0.0, 2.5, 2.5, "Dezorientator", null, 0.00, 0.50, 1.50, 10.0, StatCode.Dex, StatCode.Int, true ),
			new SkillInfo(16, "Madrosc", 0.0, 0.0, 0.0, "Medrzec",             null, 2.00, 0.00, 6.00, 1.00, StatCode.Int, StatCode.Str),
			new SkillInfo(17, "Leczenie", 6.0, 6.0, 8.0, "Lekarz",             null, 0.00, 1.20, 2.00, 5.00, StatCode.Int, StatCode.Dex),
			new SkillInfo(18, "Rybactwo", 0.0, 0.0, 0.0, "Rybak",              null, 4.00, 6.00, 0.00, 8.50, StatCode.Dex, StatCode.Str),
			new SkillInfo(19, "Zielarstwo", 0.0, 0.0, 0.0, "Zielarz",          null, 0.00, 1.00, 2.00, 3.50, StatCode.Int, StatCode.Dex),
			new SkillInfo(20, "Pasterstwo", 16.25, 6.25, 2.5, "Pasterz",       null, 0.00, 0.00, 6.00, 1.00, StatCode.Int, StatCode.Dex),
			new SkillInfo(21, "Ukrywanie", 0.0, 0.0, 0.0, "Cien",              null, 0.00, 5.00, 2.00, 5.00, StatCode.Dex, StatCode.Int),
			new SkillInfo(22, "Prowakacja", 0.0, 4.5, 0.5, "Prowokator",       null, 0.00, 1.00, 2.00, 10.0, StatCode.Int, StatCode.Dex, true ),
			new SkillInfo(23, "Inskrypcja", 0.0, 2.0, 8.0, "Skryba",           null, 0.00, 1.00, 3.00, 1.50, StatCode.Int, StatCode.Dex),
			new SkillInfo(24, "Wlamywanie", 0.0, 25.0, 0.0, "Wlamywacz",       null, 0.00, 2.00, 1.00, 1.00, StatCode.Dex, StatCode.Int),
			new SkillInfo(25, "Magia", 0.0, 0.0, 15.0, "Mag",                  null, 2.00, 0.00, 6.00, 2.50, StatCode.Int, StatCode.Str, true ),
			new SkillInfo(26, "Odpornosc na magie", 0.0, 0.0, 0.0, "Odporny",  null, 4.00, 0.00, 4.00, 1.50, StatCode.Str, StatCode.Dex),
			new SkillInfo(27, "Taktyka", 0.0, 0.0, 0.0, "Taktyk",              null, 4.00, 2.00, 0.00, 3.00, StatCode.Str, StatCode.Dex),
			new SkillInfo(28, "Zagladanie", 0.0, 25.0, 0.0, "Szpieg",          null, 0.00, 4.00, 2.00, 1.00, StatCode.Dex, StatCode.Int),
			new SkillInfo(29, "Muzykalnosc", 0.0, 0.0, 0.0, "Bard",            null, 0.00, 2.00, 1.00, 1.50, StatCode.Dex, StatCode.Int),
			new SkillInfo(30, "Zatruwanie", 0.0, 4.0, 16.0, "Morderca",        null, 0.00, 2.00, 1.50, 4.00, StatCode.Int, StatCode.Dex, true ),
			new SkillInfo(31, "Lucznictwo", 2.5, 7.5, 0.0, "Lucznik",          null, 2.00, 4.00, 0.00, 2.60, StatCode.Dex, StatCode.Str, true ),
			new SkillInfo(32, "Rozmowa z Duchami", 0.0, 0.0, 0.0, "Medium",    null, 0.50, 0.00, 4.00, 5.75, StatCode.Int, StatCode.Str, false, true),
			new SkillInfo(33, "Okradanie", 0.0, 10.0, 0.0, "Kieszonkowiec",    null, 0.00, 5.00, 1.50, 10.5, StatCode.Dex, StatCode.Int),
			new SkillInfo(34, "Krawiectwo", 3.75, 16.25, 5.0, "Krawiec",       null, 0.00, 3.50, 0.50, 2.50, StatCode.Dex, StatCode.Int),
			new SkillInfo(35, "Oswajanie", 14.0, 2.0, 4.0, "Oswajacz",         null, 4.00, 0.00, 2.00, 10.5, StatCode.Str, StatCode.Int, true ),
			new SkillInfo(36, "Ocena Smakiem", 0.0, 0.0, 0.0, "Degustator",    null, 0.00, 10.0, 0.00, 1.50, StatCode.Int, StatCode.Str),
			new SkillInfo(37, "Majsterkowanie", 5.0, 2.0, 3.0, "Majster",      null, 0.00, 3.00, 1.00, 1.50, StatCode.Dex, StatCode.Int),
			new SkillInfo(38, "Tropienie", 0.0, 12.5, 12.5, "Tropiciel",       null, 0.00, 3.50, 3.00, 10.5, StatCode.Int, StatCode.Dex),
			new SkillInfo(39, "Weterynaria", 8.0, 4.0, 8.0, "Weterynarz",      null, 0.00, 4.00, 3.00, 2.50, StatCode.Int, StatCode.Dex),
			new SkillInfo(40, "Walka Mieczami", 7.5, 2.5, 0.0, "Miecznik",     null, 6.00, 4.00, 0.00, 2.25, StatCode.Str, StatCode.Dex, true ),
			new SkillInfo(41, "Walka Obuchami", 9.0, 1.0, 0.0, "Młotnik",      null, 6.00, 4.00, 0.00, 2.35, StatCode.Str, StatCode.Dex, true ),
			new SkillInfo(42, "Szermierka", 4.5, 5.5, 0.0, "Szermierz",        null, 6.00, 4.00, 0.00, 2.15, StatCode.Dex, StatCode.Str, true ),
			new SkillInfo(43, "Walka Piesciami", 9.0, 1.0, 0.0, "Piesciarz",   null, 6.00, 4.00, 0.00, 2.50, StatCode.Str, StatCode.Dex, true ),
			new SkillInfo(44, "Drawlstwo", 20.0, 0.0, 0.0, "Drwal",            null, 6.00, 2.00, 0.00, 5.00, StatCode.Str, StatCode.Dex),
			new SkillInfo(45, "Gornictwo", 20.0, 0.0, 0.0, "Gornik",           null, 6.50, 2.00, 0.00, 5.00, StatCode.Str, StatCode.Dex),
			new SkillInfo(46, "Medytacja", 0.0, 0.0, 0.0, "Stoik",             null, 0.50, 0.00, 6.00, 4.00, StatCode.Int, StatCode.Str),
			...
			new SkillInfo(54, "Druidyzm", 0.0, 0.0, 0.0, "Druid",              null, 1.50, 0.00, 4.00, 2.50, StatCode.Int, StatCode.Str, true),
			new SkillInfo(55, "Mistycyzm", 0.0, 0.0, 0.0, "Mistyk",            null, 1.50, 0.00, 4.00, 2.50, StatCode.Int, StatCode.Str, true ),
			new SkillInfo(56, "Imbuing", 0.0, 0.0, 0.0, "Artificer",           null, 1.00, 0.00, 2.00, 2.00, StatCode.Int, StatCode.Str),
			new SkillInfo(57, "Rzucanie", 0.0, 0.0, 0.0, "Rzucacz",            null, 2.00, 4.00, 0.00, 2.00, StatCode.Dex, StatCode.Str, true ),
		};
