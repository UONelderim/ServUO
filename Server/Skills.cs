...
namespace Server
{
	...
	public class SkillInfo
	{
		...
		private static SkillInfo[] m_Table = new SkillInfo[58]
		{
			...
			new SkillInfo(15, "Dezorientacja", 0.0, 2.5, 2.5, "Dezorientator", null, 0.00, 0.50, 1.50, 1.50, StatCode.Dex, StatCode.Int, true ),
			...
			new SkillInfo(22, "Prowakacja", 0.0, 4.5, 0.5, "Prowokator",       null, 0.00, 1.00, 2.00, 11.5, StatCode.Int, StatCode.Dex, true ),
