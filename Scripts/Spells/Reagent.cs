...
namespace Server.Spells
{
	public class Reagent
	{
		private static readonly Type[] m_Types =
		{
			...
			typeof(Nightshade), typeof(SulfurousAsh), typeof(SpidersSilk), typeof(BatWing), typeof(GraveDust),
			typeof(DaemonBlood), typeof(NoxCrystal), typeof(PigIron), typeof(Bone), typeof(DragonBlood),
			typeof(FertileDirt), typeof(DaemonBone), typeof(PowderOfTranslocation),
		};
		...
		public static Type PowderOfTranslocation
		{
			get
			{
				return m_Types[17];
