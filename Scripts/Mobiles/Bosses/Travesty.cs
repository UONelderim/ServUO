...
namespace Server.Mobiles
{
	...
	public class Travesty : BasePeerless
	{
		...
		{
			new Point3D(71, 1939, 0), new Point3D(71, 1955, 0), new Point3D(69, 1972, 0), new Point3D(86, 1971, 0),
			new Point3D(103, 1972, 0), new Point3D(86, 1939, 0), new Point3D(102, 1938, 0),
		};
