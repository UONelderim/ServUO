...
namespace Server.Mobiles
{
    ...
    public partial class BaseCreature : Mobile, ITamable, IHonorTarget, IEngravable
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            {
	            m_CurrentAI = m_CurrentAI switch
	            {
		            AIType.AI_UNUSED4 => AIType.AI_Mage, //Boss
		            ...
		            AIType.AI_Spellbinder => AIType.AI_Mage,
        ...
        protected override void OnTick()
        {
            ...
            Parallel.ForEach(World.Mobiles.Values, m =>
            {
                ...
                else if (m is BaseCreature c)
                {
                    ...
                    if (!c.Controlled && !c.IsStabled && c.Owners.Count <= 0 && ((c.Region.IsPartOf<HouseRegion>() && c.CanBeDamaged()) || (c.RemoveIfUntamed && c.Spawner == null)))
                    {
                        if (++c.RemoveStep >= 20)
                        {
							toRemove.Enqueue(c);
