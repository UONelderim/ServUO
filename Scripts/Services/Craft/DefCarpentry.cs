...
namespace Server.Engines.Craft
{
    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(RedHangingLantern), 1044566, 1029412, 65.0, 90.0, typeof(Board), 1044041, 5, 1044351);
            AddRes(index, typeof(BlankScroll), 1044377, 10, 1044378);

            index = AddCraft(typeof(WhiteHangingLantern), 1044566, 1029416, 65.0, 90.0, typeof(Board), 1044041, 5, 1044351);
            AddRes(index, typeof(BlankScroll), 1044377, 10, 1044378);
	        #endregion
	        
	        #region Ozdoby 1062760
	        AddCraft(typeof(EasleSouth), 1062760, 1044317, 86.8, 111.8, typeof(Board), 1044041, 20, 1044351);
	        AddCraft(typeof(EasleEast), 1062760, 1044318, 86.8, 111.8, typeof(Board), 1044041, 20, 1044351);
	        AddCraft(typeof(EasleNorth), 1062760, 1044319, 86.8, 111.8, typeof(Board), 1044041, 20, 1044351);
	        
	        index = AddCraft(typeof(ElvenWashBasinSouthWithDrawerDeed), 1062760, 1072865, 70.0, 95.0, typeof(Board), 1044041, 40, 1044351);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(ElvenWashBasinEastWithDrawerDeed), 1062760, 1073387, 70.0, 95.0, typeof(Board), 1044041, 40, 1044351);
	        ForceNonExceptional(index);
	        
	        index = AddCraft(typeof(ShojiScreen), 1062760, 1029423, 80.0, 105.0, typeof(Board), 1044041, 75, 1044351);
	        AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
	        AddRes(index, typeof(Cloth), 1044286, 60, 1044287);

	        index = AddCraft(typeof(BambooScreen), 1062760, 1029428, 80.0, 105.0, typeof(Board), 1044041, 75, 1044351);
	        AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
	        AddRes(index, typeof(Cloth), 1044286, 60, 1044287);
	        
	        index = AddCraft(typeof(ArcanistStatueSouthDeed), 1062760, 1072885, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(ArcanistStatueEastDeed), 1062760, 1072886, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(WarriorStatueSouthDeed), 1062760, 1072887, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        AddRecipe(index, (int)CarpRecipes.WarriorStatueSouth);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(WarriorStatueEastDeed), 1062760, 1072888, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        AddRecipe(index, (int)CarpRecipes.WarriorStatueEast);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(SquirrelStatueSouthDeed), 1062760, 1072884, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        AddRecipe(index, (int)CarpRecipes.SquirrelStatueSouth);
	        ForceNonExceptional(index);

	        index = AddCraft(typeof(SquirrelStatueEastDeed), 1062760, 1073398, 0.0, 35.0, typeof(Board), 1044041, 250, 1044351);
	        AddRecipe(index, (int)CarpRecipes.SquirrelStatueEast);
	        ForceNonExceptional(index);
	        
	        index = AddCraft(typeof(ArcaneCircleDeed), 1062760, 1072703, 94.7, 119.7, typeof(Board), 1044041, 100, 1044351);
            ...
            index = AddCraft(typeof(PentagramDeed), 1062760, 1044328, 100.0, 125.0, typeof(Board), 1044041, 100, 1044351);
            AddSkill(index, SkillName.Magery, 75.0, 80.0);
            AddRes(index, typeof(IronIngot), 1044036, 40, 1044037);
            ForceNonExceptional(index);

            index = AddCraft(typeof(AbbatoirDeed), 1062760, 1044329, 100.0, 125.0, typeof(Board), 1044041, 100, 1044351);
            AddSkill(index, SkillName.Magery, 50.0, 55.0);
            AddRes(index, typeof(IronIngot), 1044036, 40, 1044037);
            ForceNonExceptional(index);

            index = AddCraft(typeof(TallElvenBedSouthDeed), 1062760, 1072858, 94.7, 119.7, typeof(Board), 1044041, 200, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);
            AddRecipe(index, (int)CarpRecipes.TallElvenBedSouth);
            ForceNonExceptional(index);

            index = AddCraft(typeof(TallElvenBedEastDeed), 1062760, 1072859, 94.7, 119.7, typeof(Board), 1044041, 200, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);
            AddRecipe(index, (int)CarpRecipes.TallElvenBedEast);
            ForceNonExceptional(index);

            index = AddCraft(typeof(ElvenBedSouthDeed), 1062760, 1072860, 94.7, 119.7, typeof(Board), 1044041, 100, 1044351);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);
            ForceNonExceptional(index);

            index = AddCraft(typeof(ElvenBedEastDeed), 1062760, 1072861, 94.7, 119.7, typeof(Board), 1044041, 100, 1044351);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);
            ForceNonExceptional(index);

            index = AddCraft(typeof(SmallBedSouthDeed), 1062760, 1044321, 94.7, 119.8, typeof(Board), 1044041, 100, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);

            index = AddCraft(typeof(SmallBedEastDeed), 1062760, 1044322, 94.7, 119.8, typeof(Board), 1044041, 100, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 100, 1044287);

            index = AddCraft(typeof(LargeBedSouthDeed), 1062760, 1044323, 94.7, 119.8, typeof(Board), 1044041, 150, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 150, 1044287);

            index = AddCraft(typeof(LargeBedEastDeed), 1062760, 1044324, 94.7, 119.8, typeof(Board), 1044041, 150, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 150, 1044287);

            AddCraft(typeof(DartBoardSouthDeed), 1062760, 1044325, 15.7, 40.7, typeof(Board), 1044041, 5, 1044351);
            AddCraft(typeof(DartBoardEastDeed), 1062760, 1044326, 15.7, 40.7, typeof(Board), 1044041, 5, 1044351);
            AddCraft(typeof(BallotBoxDeed), 1062760, 1044327, 47.3, 72.3, typeof(Board), 1044041, 5, 1044351);
            AddCraft(typeof(ParrotPerchAddonDeed), 1062760, 1072617, 50.0, 85.0, typeof(Board), 1044041, 100, 1044351);
	        AddCraft(typeof(GiantReplicaAcorn), 1062760, 1072889, 80.0, 105.0, typeof(Board), 1044041, 35, 1044351);
	        AddCraft(typeof(PlainWoodenShelfSouthDeed), 1062760, 1154160, 40.0, 90.0, typeof(Board), 1044041, 15, 1044351);
	        AddCraft(typeof(PlainWoodenShelfEastDeed), 1062760, 1154161, 40.0, 90.0, typeof(Board), 1044041, 15, 1044351);
	        AddCraft(typeof(FancyWoodenShelfSouthDeed), 1062760, 1154158, 40.0, 90.0, typeof(Board), 1044041, 15, 1044351);
	        AddCraft(typeof(FancyWoodenShelfEastDeed), 1062760, 1154159, 40.0, 90.0, typeof(Board), 1044041, 15, 1044351);
	        
	        index = AddCraft(typeof(GargishBanner), 1062760, 1095312, 94.7, 115.0, typeof(Board), 1044041, 50, 1044351);
	        AddSkill(index, SkillName.Tailoring, 75.0, 105.0);
	        AddRes(index, typeof(Cloth), 1044286, 50, 1044287);
	        
	        AddCraft(typeof(ChickenCoop), 1062760, 1112570, 90.0, 115.0, typeof(Board), 1044041, 150, 1044351);
	        AddCraft(typeof(Incubator), 1062760, 1112479, 90.0, 115.0, typeof(Board), 1044041, 100, 1044351);
	        
	         index = AddCraft(typeof(PlantTapestrySouthDeed), 1062760, 1154146, 85.0, 110.0, typeof(Board), 1044041, 12, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 50, 1044287);

            index = AddCraft(typeof(PlantTapestryEastDeed), 1062760, 1154147, 85.0, 110.0, typeof(Board), 1044041, 12, 1044351);
            AddSkill(index, SkillName.Tailoring, 75.0, 80.0);
            AddRes(index, typeof(Cloth), 1044286, 50, 1044287);
            
            index = AddCraft(typeof(SmallDisplayCaseSouthDeed), 1062760, 1155842, 95.0, 120.0, typeof(Board), 1044041, 40, 1044351);
            AddSkill(index, SkillName.Tinkering, 75.0, 80.0);
            AddRes(index, typeof(IronIngot), 1044036, 10, 1044037);

            index = AddCraft(typeof(SmallDisplayCaseEastDeed), 1062760, 1155843, 95.0, 120.0, typeof(Board), 1044041, 40, 1044351);
            AddSkill(index, SkillName.Tinkering, 75.0, 80.0);
            AddRes(index, typeof(IronIngot), 1044036, 10, 1044037);
            
            index = AddCraft(typeof(SmallElegantAquariumDeed), 1062760, 1159134, 100.0, 160.0, typeof(Board), 1044041, 20, 1044351);
            ...
            index = AddCraft(typeof(WallMountedAquariumDeed), 1062760, 1159135, 100.0, 160.0, typeof(Board), 1044041, 50, 1044351);
            ...
            index = AddCraft(typeof(LargeElegantAquariumDeed), 1062760, 1159136, 100.0, 160.0, typeof(Board), 1044041, 100, 1044351);
            ...
            index = AddCraft(typeof(TambourineTassel), 1044298, 1044320, 57.8, 82.8, typeof(Board), 1044041, 15, 1044351);
            AddSkill(index, SkillName.Musicianship, 45.0, 50.0);
            AddRes(index, typeof(Cloth), 1044286, 15, 1044287);

            index = AddCraft(typeof(BambooFlute), 1044298, 1030247, 80.0, 105.0, typeof(Board), 1044041, 15, 1044351);
            AddSkill(index, SkillName.Musicianship, 45.0, 50.0);

            index = AddCraft(typeof(AudChar), 1044298, 1095315, 78.9, 103.9, typeof(Board), 1044041, 35, 1044351);
            AddSkill(index, SkillName.Musicianship, 45.0, 50.0);
            ...
            index = AddCraft(typeof(WallMountedBellSouthDeed), 1044298, 1154162, 75.0, 105.0, typeof(Board), 1044041, 50, 1044351);
            AddSkill(index, SkillName.Musicianship, 45.0, 50.0);
            AddRes(index, typeof(IronIngot), 1044036, 50, 1044037);

            index = AddCraft(typeof(WallMountedBellEastDeed), 1044298, 1154163, 75.0, 105.0, typeof(Board), 1044041, 50, 1044351);
            AddSkill(index, SkillName.Musicianship, 45.0, 50.0);
            AddRes(index, typeof(IronIngot), 1044036, 50, 1044037);
            ...
            index = AddCraft(typeof(ElvenSpinningwheelEastDeed), 1111809, 1073393, 75.0, 100.0, typeof(Board), 1044041, 60, 1044351);
            AddSkill(index, SkillName.Tailoring, 65.0, 85.0);
            AddRes(index, typeof(Cloth), 1044286, 40, 1044287);
            ForceNonExceptional(index);

            index = AddCraft(typeof(ElvenSpinningwheelSouthDeed), 1111809, 1072878, 75.0, 100.0, typeof(Board), 1044041, 60, 1044351);
            AddSkill(index, SkillName.Tailoring, 65.0, 85.0);
            AddRes(index, typeof(Cloth), 1044286, 40, 1044287);
            ForceNonExceptional(index);

            index = AddCraft(typeof(ElvenStoveSouthDeed), 1111809, 1073394, 85.0, 110.0, typeof(Board), 1044041, 80, 1044351);
            ForceNonExceptional(index);

            index = AddCraft(typeof(ElvenStoveEastDeed), 1111809, 1073395, 85.0, 110.0, typeof(Board), 1044041, 80, 1044351);
            ForceNonExceptional(index);

            index = AddCraft(typeof(SpinningwheelEastDeed), 1111809, 1044341, 73.6, 98.6, typeof(Board), 1044041, 75, 1044351);
            AddSkill(index, SkillName.Tailoring, 65.0, 70.0);
            AddRes(index, typeof(Cloth), 1044286, 25, 1044287);

            index = AddCraft(typeof(SpinningwheelSouthDeed), 1111809, 1044342, 73.6, 98.6, typeof(Board), 1044041, 75, 1044351);
            AddSkill(index, SkillName.Tailoring, 65.0, 70.0);
            AddRes(index, typeof(Cloth), 1044286, 25, 1044287);
            ...
            // Training
            index = AddCraft(typeof(TrainingDummyEastDeed), 1111809, 1044335, 68.4, 93.4, typeof(Board), 1044041, 55, 1044351);
            AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
            AddRes(index, typeof(Cloth), 1044286, 60, 1044287);

            index = AddCraft(typeof(TrainingDummySouthDeed), 1111809, 1044336, 68.4, 93.4, typeof(Board), 1044041, 55, 1044351);
            AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
            AddRes(index, typeof(Cloth), 1044286, 60, 1044287);

            index = AddCraft(typeof(PickpocketDipEastDeed), 1111809, 1044337, 73.6, 98.6, typeof(Board), 1044041, 65, 1044351);
            AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
            AddRes(index, typeof(Cloth), 1044286, 60, 1044287);

            index = AddCraft(typeof(PickpocketDipSouthDeed), 1111809, 1044338, 73.6, 98.6, typeof(Board), 1044041, 65, 1044351);
            AddSkill(index, SkillName.Tailoring, 50.0, 55.0);
            AddRes(index, typeof(Cloth), 1044286, 60, 1044287);
	        #endregion
            ...
            AddCraft(typeof(ElvenPodium), 1044291, 1073399, 80.0, 105.0, typeof(Board), 1044041, 20, 1044351);
