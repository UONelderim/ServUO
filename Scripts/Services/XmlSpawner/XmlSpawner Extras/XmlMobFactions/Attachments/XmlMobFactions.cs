...
namespace Server.Engines.XmlSpawner2
{
	public class XmlMobFactions : XmlAttachment
	{
		...
		private bool
			verboseMobFactions =
				true; // determines whether faction gain/lost messages are displayed on each kill. True by default
		...
		private static Type[] HumanoidMembers =
			new Type[]
			{
				...
				typeof(JukaWarrior), typeof(Betrayer), typeof(Ettin), typeof(Ratman), typeof(RatmanMage),
				typeof(RatmanArcher)
			};
		...
		private static Type[] UndeadMembers =
			new Type[]
			{
				typeof(AncientLich), typeof(Bogle), typeof(BoneMagi), typeof(Lich), typeof(LichLord), typeof(Shade),
				typeof(Spectre), typeof(Wraith), typeof(BoneKnight), typeof(Ghoul), typeof(Mummy),
				typeof(SkeletalKnight), typeof(Skeleton), typeof(Zombie), typeof(Succubus), typeof(SkeletalMage),
		...
		private static Type[] ReptilianMembers =
			new Type[]
			{
				...
				typeof(OphidianWarrior), typeof(IceSerpent), typeof(GiantIceWorm), typeof(GiantSerpent),
				typeof(IceSnake), typeof(LavaSerpent), typeof(LavaSnake), typeof(SilverSerpent), typeof(Snake),
				typeof(SeaSerpent), typeof(Kraken), typeof(DeepSeaSerpent)
			};
		...
		private static Type[] ArachnidMembers =
			new Type[]
			{
				...
				typeof(Scorpion), typeof(Mephitis), typeof(SolenHelper), typeof(RedSolenWorker),
				typeof(RedSolenWarrior), typeof(RedSolenQueen), typeof(RedSolenInfiltratorWarrior),
				typeof(RedSolenInfiltratorQueen), typeof(AntLion), typeof(Beetle)
			};
		...
		private static Type[] ElementalMembers =
			new Type[]
			{
				...
				typeof(ValoriteElemental), typeof(VeriteElemental), typeof(PoisonElemental), typeof(FireElemental),
				typeof(SummonedFireElemental), typeof(SnowElemental), typeof(AirElemental),
				typeof(SummonedAirElemental), typeof(WaterElemental), typeof(SummonedWaterElemental),
				typeof(CrystalElemental), typeof(AcidElemental), typeof(Efreet)
			};
		...
		private static Type[] AbyssMembers =
			new Type[]
			{
				...
				typeof(HordeMinion), typeof(IceFiend), typeof(Imp), typeof(StoneGargoyle), typeof(HellHound),
				typeof(EnslavedGargoyle), typeof(Nightmare)
			};

		private static Type[] FairieMembers =
			new Type[] { typeof(Pixie), typeof(Wisp), typeof(ShadowWisp), typeof(EtherealWarrior) };

		private static Type[] PlantMembers =
			new Type[]
			{
				typeof(SwampTentacle), typeof(Quagmire), typeof(Corpser), typeof(BogThing), typeof(Bogling),
				typeof(WhippingVine), typeof(Reaper)
			};

		private static Type[] UnderworldMembers =
			new Type[]
			{
				typeof(Gazer), typeof(ElderGazer), typeof(WandererOfTheVoid), typeof(WailingBanshee),
				typeof(VampireBat), typeof(Revenant), typeof(Ravager), typeof(Impaler), typeof(GoreFiend),
				typeof(Gibberling), typeof(FleshRenderer), typeof(PatchworkSkeleton), typeof(FleshGolem),
				typeof(FleshRenderer), typeof(Devourer), typeof(DarknightCreeper), typeof(AbysmalHorror),
		...
		public static new void Initialize()
		{
			...
			CommandSystem.Register("VerboseMobFactions", AccessLevel.Player,
				new CommandEventHandler(VerboseMobFactions_OnCommand));
			CommandSystem.Register("AddAllMobFactions", AccessLevel.Administrator,
				new CommandEventHandler(AddAllMobFactions_OnCommand));
			CommandSystem.Register("RemoveAllMobFactions", AccessLevel.Administrator,
				new CommandEventHandler(RemoveAllMobFactions_OnCommand));
			CommandSystem.Register("CheckMobFactions", AccessLevel.Player,
				new CommandEventHandler(CheckMobFactions_OnCommand));
			...
			PlayerGroup.Opponents = new Group[]
			{
				ArachnidGroup, HumanoidGroup, UndeadGroup, ReptilianGroup, ElementalGroup, AbyssGroup
			};
			PlayerGroup.OpponentGain =
				new double[] { 2, 1, 2, 2, 1, 4 }; // scale factor for faction gained by opponent groups
			...
			{
				PlayerGroup, UndeadGroup, HumanoidGroup, ArachnidGroup, ReptilianGroup, ElementalGroup, AbyssGroup,
				FairieGroup, PlantGroup, UnderworldGroup, NecroMastersGroup
			};
		}
		...
		public int Player
		{
			get { return GetFactionLevel(GroupTypes.Player); }
			set { SetFactionLevel(GroupTypes.Player, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Humanoid
		{
			get { return GetFactionLevel(GroupTypes.Humanoid); }
			set { SetFactionLevel(GroupTypes.Humanoid, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Undead
		{
			get { return GetFactionLevel(GroupTypes.Undead); }
			set { SetFactionLevel(GroupTypes.Undead, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Reptilian
		{
			get { return GetFactionLevel(GroupTypes.Reptilian); }
			set { SetFactionLevel(GroupTypes.Reptilian, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Arachnid
		{
			get { return GetFactionLevel(GroupTypes.Arachnid); }
			set { SetFactionLevel(GroupTypes.Arachnid, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Elemental
		{
			get { return GetFactionLevel(GroupTypes.Elemental); }
			set { SetFactionLevel(GroupTypes.Elemental, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Abyss
		{
			get { return GetFactionLevel(GroupTypes.Abyss); }
			set { SetFactionLevel(GroupTypes.Abyss, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int DragonLords
		{
			get { return GetFactionLevel(GroupTypes.DragonLords); }
			set { SetFactionLevel(GroupTypes.DragonLords, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int NecroMasters
		{
			get { return GetFactionLevel(GroupTypes.NecroMasters); }
			set { SetFactionLevel(GroupTypes.NecroMasters, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Fairie
		{
			get { return GetFactionLevel(GroupTypes.Fairie); }
			set { SetFactionLevel(GroupTypes.Fairie, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Plant
		{
			get { return GetFactionLevel(GroupTypes.Plant); }
			set { SetFactionLevel(GroupTypes.Plant, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public int Underworld
		{
			get { return GetFactionLevel(GroupTypes.Underworld); }
			set { SetFactionLevel(GroupTypes.Underworld, value); }
		}
		...
		static int
			baseValue = 180000; // increasing this increases the faction effect on delayed acquisition. Higher=longer average delay
		...
		private static Dictionary<Type, List<XmlMobFactions.GroupTypes>> GroupTypeHash =
			new Dictionary<Type, List<XmlMobFactions.GroupTypes>>();
		...
		public class Group
		{
			...
			public GroupTypes
				GroupType; //an attachment added to this list? this allows what? we can't add manually attachment in this way!
		...
		public static void AddAllMobFactions_OnCommand(CommandEventArgs e)
		{
			...
			foreach (Mobile m in World.Mobiles.Values)
			{
				if (m.Player)
				{
					...
					XmlMobFactions x =
						XmlAttach.FindAttachment(m, typeof(XmlMobFactions), "Standard") as XmlMobFactions;
					if (x == null)
					{
		...
		public static void RemoveAllMobFactions_OnCommand(CommandEventArgs e)
		{
			...
			foreach (Mobile m in World.Mobiles.Values)
			{
				if (m.Player)
				{
					var list = XmlAttach.FindAttachments(XmlAttach.MobileAttachments, m, typeof(XmlMobFactions),
						"Standard");
			...
			e.Mobile.SendMessage("Removed XmlMobFaction attachments from {0} players ({1} total players)", count,
				total);
		}
		...
		private static Dictionary<Type, List<XmlMobFactions.Group>> GroupHash =
			new Dictionary<Type, List<XmlMobFactions.Group>>();
		...
		private class MobFactionGump : Gump
		{
			...
			public MobFactionGump(Mobile from, XmlMobFactions a, string text) : base(0, 0)
			{
				...
				AddButton(20, 290, (a.verboseMobFactions ? 0xD3 : 0xD2), (a.verboseMobFactions ? 0xD2 : 0xD3), 100,
		...
		public override string OnIdentify(Mobile from)
		{
			...
			if (AttachedTo is Mobile &&
			    (from != (Mobile)AttachedTo && from != null && from.AccessLevel == AccessLevel.Player)) return null;
