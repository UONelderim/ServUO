...
namespace Server.Engines.XmlSpawner2
{
	public class XmlMobFactionsRewards
	{
		...
		public XmlMobFactionsRewards(string faction, int minfaction, Type reward, string name, int cost, int id,
			object[] args)
		{
			RewardType = reward;
			Cost = cost;
		...
		public static void Initialize()
		{
			...
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 1000, typeof(LeatherGlovesOfMining),
				"+20 Leather Gloves Of Mining", 20000, 0x13c6, new object[] { 20 }));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 1000, typeof(ColoredAnvil), "Colored Anvil",
				40000, 0xFAF, null));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 1000, typeof(PowderOfTemperament),
				"Powder Of Temperament, 10 uses", 30000, 4102, new object[] { 10 }));
			...
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 2500, typeof(AncientSmithyHammer),
				"+20 Ancient Smithy Hammer, 50 uses", 50000, 0x13E4, new object[] { 20, 50 }));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 5000, typeof(PowerScroll),
				"105 Smithing powerscroll", 100000, 0x14F0, new object[] { SkillName.Blacksmith, 105 }));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 8000, typeof(PowerScroll),
				"110 Smithing powerscroll", 200000, 0x14F0, new object[] { SkillName.Blacksmith, 110 }));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 12000, typeof(PowerScroll),
				"115 Smithing powerscroll", 350000, 0x14F0, new object[] { SkillName.Blacksmith, 115 }));
			MobFactionsRewardList.Add(new XmlMobFactionsRewards("Player", 20000, typeof(PowerScroll),
				"120 Smithing powerscroll", 600000, 0x14F0, new object[] { SkillName.Blacksmith, 120 }));
