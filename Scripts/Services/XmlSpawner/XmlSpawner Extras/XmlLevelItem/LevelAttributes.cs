namespace Server.Items
{
	...
	public class LevelAttributes
	{
		public static AttributeInfo[] m_Attributes = new AttributeInfo[]
		{
			...
			new AttributeInfo(AosAttribute.ReflectPhysical, "Reflect Physical Damage", AttributeCategory.Melee, 2,
				15),
		...
		{
			new WeaponAttributeInfo(AosWeaponAttribute.LowerStatReq, "Lower Stat Requirement",
				AttributeCategory.Stats, 2, 100),
			new WeaponAttributeInfo(AosWeaponAttribute.SelfRepair, "Self Repair", AttributeCategory.Misc, 2, 10),
			new WeaponAttributeInfo(AosWeaponAttribute.HitLeechHits, "Hit Life Leech", AttributeCategory.Hits, 3,
				50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitLeechStam, "Hit Stamina Leech", AttributeCategory.Hits, 3,
				50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitLeechMana, "Hit Mana Leech", AttributeCategory.Hits, 3,
				50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitLowerAttack, "Hit Lower Attack", AttributeCategory.Hits,
				3, 50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitLowerDefend, "Hit Lower Defence", AttributeCategory.Hits,
				3, 50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitMagicArrow, "Hit Magic Arrow", AttributeCategory.Hits, 3,
				50),
			...
			new WeaponAttributeInfo(AosWeaponAttribute.HitLightning, "Hit Lightning", AttributeCategory.Hits, 3,
				50),
			...
			new WeaponAttributeInfo(AosWeaponAttribute.HitPoisonArea, "Hit Poison Area", AttributeCategory.Hits, 3,
				50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitEnergyArea, "Hit Energy Area", AttributeCategory.Hits, 3,
				50),
			new WeaponAttributeInfo(AosWeaponAttribute.HitPhysicalArea, "Hit Physical Area", AttributeCategory.Hits,
				3, 50),
			new WeaponAttributeInfo(AosWeaponAttribute.ResistPhysicalBonus, "Resist Physical Bonus",
				AttributeCategory.Resists, 40, 20),
			new WeaponAttributeInfo(AosWeaponAttribute.ResistFireBonus, "Resist Fire Bonus",
				AttributeCategory.Resists, 5, 20),
			new WeaponAttributeInfo(AosWeaponAttribute.ResistColdBonus, "Resist Cold Bonus",
				AttributeCategory.Resists, 5, 20),
			new WeaponAttributeInfo(AosWeaponAttribute.ResistPoisonBonus, "Resist Poison Bonus",
				AttributeCategory.Resists, 5, 20),
			new WeaponAttributeInfo(AosWeaponAttribute.ResistEnergyBonus, "Resist Energy Bonus",
				AttributeCategory.Resists, 5, 20),
			new WeaponAttributeInfo(AosWeaponAttribute.UseBestSkill, "Use Best Weapon Skill",
				AttributeCategory.Misc, 10, 1),
			new WeaponAttributeInfo(AosWeaponAttribute.MageWeapon, "Mage Weapon", AttributeCategory.Magic, 5, 25),
			new WeaponAttributeInfo(AosWeaponAttribute.DurabilityBonus, "Durability Bonus", AttributeCategory.Misc,
				1, 255)
		};
		...
		{
			new ArmorAttributeInfo(AosArmorAttribute.LowerStatReq, "Lower Stat Requirement",
				AttributeCategory.Stats, 2, 100),
			...
			new ArmorAttributeInfo(AosArmorAttribute.DurabilityBonus, "Durability Bonus", AttributeCategory.Misc, 1,
				255)
		};
		...
		{
			new ResistanceTypeInfo(ResistanceType.Physical, "Physical Resistance", AttributeCategory.Resists, 2,
				20),
		...
		{
			new ElementAttributeInfo(AosElementAttribute.Physical, "Physical Resistance", AttributeCategory.Resists,
				2, 20),
			...
			new ElementAttributeInfo(AosElementAttribute.Poison, "Poison Resistance", AttributeCategory.Resists, 2,
				20),
			new ElementAttributeInfo(AosElementAttribute.Energy, "Energy Resistance", AttributeCategory.Resists, 2,
				20)
		};
	}
	...
	public class WeaponAttributeInfo
	{
		...
		public WeaponAttributeInfo(AosWeaponAttribute attribute, string name, AttributeCategory category, int xp,
			int maxvalue)
		{
			m_Attribute = attribute;
			m_Name = name;
	...
	public class ArmorAttributeInfo
	{
		...
		public ArmorAttributeInfo(AosArmorAttribute attribute, string name, AttributeCategory category, int xp,
			int maxvalue)
		{
			m_Attribute = attribute;
			m_Name = name;
	...
	public class ResistanceTypeInfo
	{
		...
		public ResistanceTypeInfo(ResistanceType attribute, string name, AttributeCategory category, int xp,
			int maxvalue)
		{
			m_Attribute = attribute;
			m_Name = name;
	...
	public class ElementAttributeInfo
	{
		...
		public ElementAttributeInfo(AosElementAttribute attribute, string name, AttributeCategory category, int xp,
			int maxvalue)
		{
			m_Attribute = attribute;
			m_Name = name;
