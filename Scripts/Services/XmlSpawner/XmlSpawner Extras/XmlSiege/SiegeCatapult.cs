...
namespace Server.Items
{
	public class SiegeCatapult : BaseSiegeWeapon
	{
		...
		public override double
			WeaponDamageFactor { get { return base.WeaponDamageFactor * 1.0; } } // damage multiplier for the weapon

		public override double
			WeaponRangeFactor { get { return base.WeaponRangeFactor * 1.0; } } //  range multiplier for the weapon

		public override int MinTargetRange { get { return 3; } } // target must be further away than this

		public override int
			MinStorageRange { get { return 2; } } // player must be at least this close to store the weapon

		public override int
			MinFiringRange { get { return 3; } } // player must be at least this close to fire the weapon
		...
		// facing 0
		public static int[] CatapultWest =
			new int[] { 5846, 5823, 5822, 5821, 5820, 5819, 5818, 5817, 5826, 5831, 5841, 5836 };
		...
		// facing 1
		public static int[] CatapultNorth =
			new int[] { 5809, 5784, 5786, 5789, 5785, 5783, 5782, 5780, 5781, 5799, 5794, 5808 };
		...
		// facing 2
		public static int[] CatapultEast =
			new int[] { 5773, 5763, 5758, 5746, 5747, 5748, 5750, 5751, 5752, 5753, 5768, 5749 };
		...
		// facing 3
		public static int[] CatapultSouth =
			new int[] { 5731, 5704, 5716, 5721, 5710, 5709, 5708, 5707, 5714, 5706, 5730, 5705 };
		...
		public void DoTimer(Mobile from, SiegeCatapult weapon, IEntity target, Point3D targetloc, Item projectile,
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer(Mobile from, SiegeCatapult weapon, IEntity target, Point3D targetloc, Item projectile,
				TimeSpan damagedelay, int step)
				...
				if (m_weapon != null && !m_weapon.Deleted && pitem != null)
				{
					...
					switch (m_step)
					{
						...
						case 2:
							...
							{
								XmlSiege.SendMovingProjectileEffect(m_weapon, null, animationid,
									m_weapon.ProjectileLaunchPoint, m_targetloc, 7, 0, false, true, animationhue);
							}
							else
							{
								XmlSiege.SendMovingProjectileEffect(m_weapon, m_target, animationid,
									m_weapon.ProjectileLaunchPoint, m_targetloc, 7, 0, false, true, animationhue);
							}
