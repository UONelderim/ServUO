...
namespace Server.Items
{
	public class SiegeCannon : BaseSiegeWeapon
	{
		...
		public override double
			WeaponDamageFactor { get { return base.WeaponDamageFactor * 1.2; } } // damage multiplier for the weapon

		public override double
			WeaponRangeFactor { get { return base.WeaponRangeFactor * 1.2; } } //  range multiplier for the weapon
		...
		public override Point3D ProjectileLaunchPoint
		{
			get
			{
				if (Components != null && Components.Count > 0)
				{
					...
					{
						case 0:
							return new Point3D(CannonWestXOffset[0] + Location.X - 1, CannonWestYOffset[0] + Location.Y,
								Location.Z + 1);
						case 1:
							return new Point3D(CannonNorthXOffset[0] + Location.X - 1,
								CannonNorthYOffset[0] + Location.Y - 1, Location.Z + 1);
						case 2:
							return new Point3D(CannonEastXOffset[0] + Location.X, CannonEastYOffset[0] + Location.Y - 1,
								Location.Z + 1);
						case 3:
							return new Point3D(CannonSouthXOffset[0] + Location.X - 1,
								CannonSouthYOffset[0] + Location.Y, Location.Z + 1);
					}
				}
