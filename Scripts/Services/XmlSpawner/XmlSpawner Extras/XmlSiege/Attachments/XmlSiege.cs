...
namespace Server.Engines.XmlSpawner2
{
	public class XmlSiege : XmlAttachment
	{
		...
		public virtual int
			WhenToAutoRepair { get { return 0; } } // 0=never, 1=after any damage, 2=after being destroyed
		...
		public class MovingProjectileEffect : HuedEffect
		{
			public MovingProjectileEffect(IEntity from, IEntity to, int itemID, Point3D fromPoint, Point3D toPoint,
				...
				: base(EffectType.Moving, from.Serial, to == null ? new Serial(-1) : to.Serial, itemID, fromPoint,
					toPoint, speed, duration, fixedDirection, explode, hue, 0)
			{
			}
		}
