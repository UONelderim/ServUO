...
namespace Server.Engines.XmlSpawner2
{
	public class MLParagon : XmlParagon
	{
		...
		private static Type[] m_MLArtifacts = new Type[]
		{
			...
			typeof(MelisandesCorrodedHatchet), typeof(PadsOfTheCuSidhe), typeof(RaedsGlory), typeof(RighteousAnger),
			typeof(RobeOfTheEclipse), typeof(RobeOfTheEquinox), typeof(SoulSeeker), typeof(TalonBite)
		};
