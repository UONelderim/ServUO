...
namespace Server.Items
{
	public class BoxOfTransmutation : BaseTransmutationContainer
	{
		...
		public static void Initialize()
		{
			...
			AddRecipe(
				(int)Recipes
					.PowerScrollSkillChange, // combines 3 powerscrolls of the same level to produce a new random ps of the same level
				50, 20, 50, // str, dex, int requirements
				new SkillName[] { SkillName.Alchemy }, //  skill requirement list
				new int[] { 100 }, // minimum skill levels
				new Type[]
				{
					typeof(LegendaryDiamond), typeof(LegendaryRuby), typeof(LegendaryEmerald), typeof(PowerScroll)
				}, // ingredient list
