...
namespace Server.Engines.XmlSpawner2
{
	public class XmlSocketable : XmlAttachment
	{
		...
		{
			get { return m_RequiredSkill2; }
			set
			{
				m_RequiredSkill2 = value;
				InvalidateParentProperties();
			}
		}
		...
		{
			get { return m_MinSkillLevel2; }
			set
			{
				m_MinSkillLevel2 = value;
				InvalidateParentProperties();
			}
		}
		...
		{
			get { return m_RequiredResource; }
			set
			{
				m_RequiredResource = value;
				InvalidateParentProperties();
			}
		}
		...
		[Attachable]
		public XmlSocketable(int maxsockets, string skillname, double minskilllevel, string skillname2,
			double minskilllevel2, string resource, int quantity)
		{
		...
		public XmlSocketable(int maxsockets, SkillName skillname, double minskilllevel, SkillName skillname2,
			double minskilllevel2, Type resource, int quantity)
		{
			MaxSockets = maxsockets;
			RequiredResource = resource;
			ResourceQuantity = quantity;
		...
		public override string OnIdentify(Mobile from)
		{
			...
			if (from != null)
			{
				...
				int success = XmlSockets.ComputeSuccessChance(from, nSockets, MinSkillLevel, RequiredSkill,
					MinSkillLevel2, RequiredSkill2);
