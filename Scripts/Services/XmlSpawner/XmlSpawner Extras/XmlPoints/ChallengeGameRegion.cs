...
namespace Server.Engines.XmlSpawner2
{
	public class ChallengeGameRegion : GuardedRegion
	{
		...
		public ChallengeGameRegion(string name, Map map, int priority, params Rectangle3D[] area) : base(name, map,
			priority, area)
		{
		}
		...
		public override bool AllowHarmful(Mobile from, IDamageable target)
		{
			...
			return target is Mobile && XmlPoints.AreChallengers(from, (Mobile)target);
		}
