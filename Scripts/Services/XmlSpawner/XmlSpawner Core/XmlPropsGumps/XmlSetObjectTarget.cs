...
#if (NEWTIMERS)
		public XmlSetObjectTarget(PropertyInfo prop, Mobile mobile, object o, Stack<PropertiesGump.StackEntry> stack,
			Type type, int page, ArrayList list) : base(-1, false, TargetFlags.None)
#else
			...
			try
			{
				if (m_Type == typeof(Type))
					targeted = targeted.GetType();
				         ...
				         targeted is AddonComponent component)
