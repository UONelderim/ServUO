...
#if (NEWTIMERS)
		public XmlSetPoint3DGump(PropertyInfo prop, Mobile mobile, object o, Stack<PropertiesGump.StackEntry> stack,
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			switch (info.ButtonID)
			{
				...
				case 3: // Use values
				{
					...
					toSet = new Point3D(x == null ? 0 : Utility.ToInt32(x.Text),
						y == null ? 0 : Utility.ToInt32(y.Text), z == null ? 0 : Utility.ToInt32(z.Text));
					shouldSet = true;
					shouldSend = true;
