...
namespace Server.Engines.XmlSpawner2
{
	public class XmlAnimate : XmlAttachment
	{
		...
		public override string OnIdentify(Mobile from)
		{
			...
			string msg = String.Format("Animation #{0},{1} : {2} secs between uses", this.AnimationValue,
				this.FrameCount, this.Refractory.TotalSeconds);
		...
		public override void OnMovement(MovementEventArgs e)
		{
			...
			if (this.AttachedTo is Item && (((Item)this.AttachedTo).Parent == null) &&
			    Utility.InRange(e.Mobile.Location, ((Item)this.AttachedTo).Location, this.ProximityRange))
			{
				this.OnTrigger(null, e.Mobile);
			}
			else
		...
		public void Animate()
		{
			...
			{
				((Mobile)this.AttachedTo).Animate(this.AnimationValue, this.FrameCount, this.RepeatCount, this.Forward,
					this.Repeat, this.AnimationDelay);
			}
