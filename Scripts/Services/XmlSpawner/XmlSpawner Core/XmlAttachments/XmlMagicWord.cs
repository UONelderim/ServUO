...
namespace Server.Engines.XmlSpawner2
{
	public class XmlMagicWord : XmlAttachment
	{
		...
		{
			"Shoda", "Malik", "Lepto", "Velas", "Tarda", "Marda", "Vas Malik", "Nartor", "Santor"
		};
		...
		private bool
			m_Identified =
				false; // optional identification flag that can suppress application of the mod until identified when applied to items

		private bool
			m_RequireIdentification = false; // by default no identification is required for the mod to be activatable
		...
		public override string OnIdentify(Mobile from)
		{
			...
			{
				msg = String.Format("{0} lasting {1} secs : {2} secs between uses", Word, Duration.TotalSeconds,
