...
namespace Server.Items
{
	public partial class SlayerGroup
	{
		...
		static SlayerGroup()
		{
			...
			{
				typeof(Balron), typeof(Daemon), typeof(Putrefier), typeof(FireDaemonRenowned)
			};
			...
			eodonTribe.Super = new SlayerEntry(SlayerName.EodonTribe, typeof(TribeWarrior), typeof(TribeShaman),
				typeof(TribeChieftan));
			...
			FillNelderimSlayerEntries(ref humanoid, ref undead, ref elemental, ref abyss, ref arachnid, ref reptilian,
				ref fey, ref eodon, ref eodonTribe, ref dino, ref myrmidex);

			m_Groups = new SlayerGroup[]
			{
				humanoid, undead, elemental, abyss, arachnid, reptilian, fey, eodon, eodonTribe, dino, myrmidex
			};
