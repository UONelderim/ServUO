...
namespace Server
{
		...
		: IMapPoint, IEquatable<MapPoint>, IEquatable<IMapPoint>, IEquatable<Map>, IEquatable<IPoint3D>, IEquatable<IPoint2D>
	{
		...
		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public int X { get { return _Location.X; } set { _Location = new Point3D(Math.Max(0, value), Y, Z); } }

		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public int Y { get { return _Location.Y; } set { _Location = new Point3D(X, Math.Max(0, value), Z); } }
		...
		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public bool Internal { get { return _Map == null || _Map == Map.Internal; } }

		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public bool Zero { get { return _Location == Point3D.Zero; } }

		public bool InternalOrZero { get { return Internal || Zero; } }
