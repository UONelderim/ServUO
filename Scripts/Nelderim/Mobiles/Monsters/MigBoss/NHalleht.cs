...
namespace Server.Mobiles
{
    public class NHalleht : BaseCreature
    {
        ...
        public override void OnSpeech( SpeechEventArgs e )
        {
            ...
            if ( from.InRange( this, 2 ) )
            {
                if ( e.Speech.ToLower().IndexOf( "zadan" ) >= 0 || e.Speech.ToLower().IndexOf( "praca" ) >= 0 )
                {
                    ...
                    this.Say( message2 );
                    string message3 = "Nastepnie zas serce Katrilla Pana Mordu.. . .. by dopelnic przeznaczenia jako ostatnie przynies mi serce Delotha Ksiecia Ciemnosci";
                    this.Say( message3 );
                }
            }
        }
        ...
        public override bool OnDragDrop( Mobile from, Item dropped )
        {
            ...
            {
                dropped.Delete();
                Say( true, " Pierwsza pieczec zostala otwarta, do otwarcia nastepnej potrzebuje serce Ksiecia Mordu - Katrilla! " );
                serce1 = 1;
            }
            ...
            {
                dropped.Delete();
                Say( true, " Druga pieczec zostala otwarta, do otwarcia ostateniej potrzebuje serce Ksiecia Ciemnosci – Delotha " );
                serce2 = 1;
            }
            ...
            if ( dropped is NSerceDelotha && serce2 > 0 )
            {
                ...
                if ( serce1 > 0 && serce2 > 0 && serce3 > 0 )
                {
                    ...
                    Say( true, " Ostatnia pieczec zostala otwarta, droga do najpotezniejszego - Wladcy Demonow, stoi otworem. Spieszcie sie gdyz zaraz sie zamknie! " );
