...
namespace Server.Mobiles
{
	...
	public class PSavageShaman : BaseCreature
	{
		[Constructable]
		public PSavageShaman() : base(AIType.AI_Mage, FightMode.Closest, 12, 5, 0.2, 0.4)
		{
			...
			SetSkill(SkillName.Magery, 80.5, 120.0);
			SetSkill(SkillName.Meditation, 77.5, 200.0);
			...
			if (list.Count > 0)
			{
				switch (Utility.Random(3))
				{
					case 0: /* greater heal */
					{
						...
						{
							bool isFriendly = (m is Savage || m is SavageRider || m is SavageShaman ||
		...
		public PSavageShaman(Serial serial) : base(serial)
		{
		}
