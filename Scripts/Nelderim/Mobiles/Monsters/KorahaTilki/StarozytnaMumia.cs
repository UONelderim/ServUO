    ...
    public class StarozytnaMumia : BaseCreature
    {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (from.InRange(this, 2))
            {
                ...
                {
                    string message1 = "Witajcie! Ta pluskwa czai sie nieopodal, przyniescie mi posoke jej pomniejszej siostry by udowodnic ze sprostacie jej mocy!";
                    this.Say(message1);
                }
            }
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if (dropped is PosokaPluskwy)
            {
                ...
                if (posoka > 0)
                {
                    ...
                    Say(true, " Portal do Leza Wielka Pluskwy zostal otwarty, ale spieszcie sie gdyz za dwie i pol klepsydry sie zamknie! ");
