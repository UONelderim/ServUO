...
namespace Server.Mobiles
{
	...
	public class RedBeetle : BaseMount
	{
		...
		public override void GetProperties(ObjectPropertyList list) // bedzie wyswietlac wage w zwierzach z paczka
		{
			...
			if (Backpack != null)
			{
				list.Add(1072241, "{0}\t{1}\t{2}\t{3}", Backpack.TotalItems, Backpack.MaxItems, Backpack.TotalWeight,
					Backpack.MaxWeight); // Contents: ~1_COUNT~/~2_MAXCOUNT~ items, ~3_WEIGHT~/~4_MAXWEIGHT~ stones
			}
		}
