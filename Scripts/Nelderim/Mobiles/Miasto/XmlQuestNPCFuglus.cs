		...
		public override void OnMovement(Mobile m, Point3D oldLocation)
		{
			if (m.Alive && m is PlayerMobile)
			{
				    ...
				    DateTime.Now >= m_Spoken + TimeSpan.FromSeconds(10))
				{
					...
					{
						case 0:
							Say("O ja biedny nieszczęśliwy!");
							Emote("*Szlocha...*");
							break;
						case 1:
							Say("Znowu mnie wyruchali bez mydła!");
							break;
						case 2:
							Say("Płaczę bo lubię!");
							Emote("*Szlocha...*");
							break;
						case 3:
							Say("Dlaczego wojownik musi mieć pod górkę?!");
							break;
						case 4:
							Say("Nie umiem, nie umiem");
							Emote("*Szlocha...*");
							break;
						case 5:
							Say("Jak się wkurwię wpadnę w furię!");
							break;
						case 6:
							Say("Do czego by się tu dzisiaj przypierdolić...");
							break;
						case 7:
							Say("O co ci kurwa chodzi co?!");
							break;
						case 8:
							Say("Czemu mnie drażnisz?");
							break;
						case 9:
							Say("Wszyscy przeciwko mnie?! Dlaczego!!!");
							break;
						case 10:
							Say("Do czego by się tu dzisiaj przypierdolić...");
							break;
						case 11:
							Say("Dobra nie mam siły do ciebie.");
							break;
						case 12:
							Say("Chciałem być kowalem, a zostałem furiatem!");
							break;
						case 13:
							Say(
							...
							break;
						case 14:
							Say("Od poł godziny probuje ustalić co ci nie pasuje...");
							break;
						case 15:
							Say("Nie pyskuj gnoju!");
							break;
						case 16:
							Say("To wszystko wina świata!");
							Emote("*Szlocha...*");
							break;
						case 17:
							Say(
