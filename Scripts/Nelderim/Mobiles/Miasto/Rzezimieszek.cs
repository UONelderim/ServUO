				    ...
				    DateTime.Now >= m_Spoken + TimeSpan.FromSeconds(10))
				{
					switch (Utility.Random(12))
					{
						case 0:
							...
							break;
						case 1:
							Say("Potnę Cię szlamo!");
							break;
						case 2:
							Say("Zabiję Ci matkę!");
							break;
						case 3:
							Say("Pieniądze albo życie! Haha i tak wezmę oba!");
							break;
						case 4:
							Say("Zaraz się przekonasz co to dobre rżnięcie!");
							break;
						case 6:
							Say("Spierdalaj bo zabije!");
							break;
						case 7:
							Say("Gdzie Ci tak kurwa śpieszno!");
							break;
						case 8:
							Say("Nikt Cie tu nie usłyszy.");
							break;
						case 9:
							Say("Dawaj co masz albo przetrące Ci łeb!");
							break;
						case 10:
							Say("Wychędoże Cie w oczodoły!");
							break;
						case 11:
							Say("Wracaj tu kurwisynu!");
							break;
					}
