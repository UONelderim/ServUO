				...
				if (Utility.RandomDouble() < 0.20)
				{
					    ...
					    DateTime.Now >= m_Spoken + TimeSpan.FromSeconds(10))
					{
						if (Race == Race.NTamael)
						{
							...
							{
								case 0:
									Say("Mogłoby troche popadać...");
									break;
								case 1:
									Say("Oby nie było suszy.");
									break;
								case 2:
									Say("Fron, Rada czy Elbern... dla mnie jeden chuj...");
									break;
								case 3:
									Say("Ah... Mam już dość.");
									break;
								case 4:
									Say("Odejdź... Mam dużo pracy.");
									Emote("*Odgania ręką*");
									break;
								case 5:
									Say("Zjeżdżaj stąd...");
								...
								case 6:
									...
									break;
								case 7:
									Say("Oby Matka zesłała urodzaj...");
									break;
								case 8:
									Say("Trza by załatać dach... znów cieknie.");
									Emote("*Wzdycha ponuro*");
									break;
								case 9:
									Say("Kończą sie zapasy, trzaby sie wybrać do Miasta.");
									break;
								case 10:
									Say("Muszę jutro zajść do młyna.");
									break;
								case 11:
									Say("Cholera, trzeba nakarmić kury.");
									break;
								case 12:
									Say("Sprawię sobie chyba nowe buty... Albo chociaż załatam stare.");
									break;
								case 13:
									Say("Oni tak zawsze obiecują... A potem nic z tego nie ma");
									break;
								case 14:
									Emote("*Rozrzuca coś na ziemi*");
									break;
								case 15:
									Emote("*Rozgląda się leniwym spojrzeniem*");
									break;
								case 16:
									Emote("*Przeciąga się*");
									break;
								case 17:
									...
									break;
								case 18:
									Emote("*Popija świeże mleko*");
									break;
								case 19:
									Say("Tasandorskie ziemie dla Tamaelów!");
									Emote("*Prycha*");
									break;
								case 20:
									Emote("*Klnie siarczyście pod nosem*");
									break;
								case 21:
									Emote("O kurwa...");
									Emote("*Zamyśla się*");
						...
						else if (Race == Race.NJarling)
						{
							switch (Utility.Random(22))
							{
								...
								case 1:
									...
									break;
								case 2:
									Say("Mam juz dość tych śmierdzących Tamaeli...");
									break;
								case 3:
									Say("Ah... Mam już dość.");
									break;
						...
						else if (Race == Race.NKrasnolud)
						{
							switch (Utility.Random(22))
							{
								...
								case 1:
									...
									break;
								case 2:
									Say("Chuj z tą władzą... dla mnie nic sie nie zmienia...");
									break;
								case 3:
									Say("Ah... Mam już dość.");
									break;
								...
								case 6:
									...
									break;
								case 7:
									Say("Oby nie było tak źle jak ostatnio...");
									break;
								case 8:
									Say("Trza by załatać dach... znów cieknie.");
									Emote("*Wzdycha ponuro*");
