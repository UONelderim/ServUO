...
namespace Server.Engines.HunterKiller
{
	...
	{
		public HKMobile(AIType aiType, FightMode mode, HunterKillerType type) : base(aiType, mode, 18,
			(type != HunterKillerType.WarriorType) ? 6 : 1, 0.1, 0.2)
		{
			Title = "- Rzezimieszek Vox Populi";
