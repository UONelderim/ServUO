...
namespace Nelderim.Races
{
    class NNaur : NRace
    {
        ...
        public override string[] PluralNames => new[] { "Naurowie", "Naurow", "Naurom", "Naurow", "Naurami", "Naurach", "Naurowie" };
        public override int DescNumber => 505817;
        public override int[] SkinHues => new[] { 1146, 1147, 1148, 1149 };
        public override int[] HairHues => new[] { 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1109, 1007, 1008, 1014, 1015,
