    ...
    public class RaceGenerator
    {
        ...
        private static void Appearance_OnCommand( CommandEventArgs e )
        {
            ...
            else
            {
                ...
                switch ( par )
                {
                    case 0: e.Mobile.Target = new AppearanceTarget( Race.DefaultRace ); break;
                    case 1: e.Mobile.Target = new AppearanceTarget( Race.NTamael); break;
                    case 2: e.Mobile.Target = new AppearanceTarget( Race.NJarling ); break;
                    case 3: e.Mobile.Target = new AppearanceTarget( Race.NKrasnolud ); break;
					
                    case 4: e.Mobile.Target = new AppearanceTarget( Race.NElf ); break;
                    case 5: e.Mobile.Target = new AppearanceTarget( Race.NDrow ); break;
                    case 6: e.Mobile.Target = new AppearanceTarget( Race.NNaur ); break;					
