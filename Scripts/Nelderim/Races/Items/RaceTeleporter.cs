...
namespace Server.Items
{
	public class RaceTeleporter : Item
	{
        ...
        public Point3D TamaelLoc
		{
            ...
            set { m_TamaelLoc = value; InvalidateProperties(); }
		}
        ...
        public Point3D JarlingLoc
		{
            ...
            set { m_JarlingLoc = value; InvalidateProperties(); }
		}
        ...
        public Point3D NaurLoc
		{
            ...
            set { m_NaurLoc = value; InvalidateProperties(); }
		}
		...
		{
            get { return m_ElfLoc; }
            set { m_ElfLoc = value; InvalidateProperties(); }
		}
        ...
        public Point3D DrowLoc
		{
            ...
            set { m_DrowLoc = value; InvalidateProperties(); }
		}
        ...
        public Point3D KrasnoludLoc
		{
            ...
            set { m_KrasnoludLoc = value; InvalidateProperties(); }
		}
		...
		public Map WorldMap
		{
			...
			set { m_WorldMap = value; InvalidateProperties(); }
		}
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (Point3D)m_TamaelLoc );
			writer.Write( (Point3D)m_JarlingLoc );
			writer.Write( (Point3D)m_NaurLoc );
			writer.Write( (Point3D)m_ElfLoc );
			writer.Write( (Point3D)m_DrowLoc );
			writer.Write( (Point3D)m_KrasnoludLoc );
