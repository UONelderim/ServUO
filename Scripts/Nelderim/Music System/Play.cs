...
namespace Server.Commands
{
	public class Play
	{
		...
		{
			CommandSystem.Register("Play", AccessLevel.Counselor, Play_OnCommand);
			CommandSystem.Register("StopMusic", AccessLevel.Player, StopMusic_OnCommand);
			CommandSystem.Register("FilterMusic", AccessLevel.Player, FilterMusic_OnCommand);
			CommandSystem.Register("MultiPlay", AccessLevel.Counselor, MultiPlay_OnCommand);
			CommandSystem.Register("PlayHarp", AccessLevel.Counselor, PlayHarp_OnCommand);
			CommandSystem.Register("PlayHarpMinor", AccessLevel.Counselor, PlayHarpMinor_OnCommand);
			CommandSystem.Register("PlayLute", AccessLevel.Counselor, PlayLute_OnCommand);
			CommandSystem.Register("PlayLuteMinor", AccessLevel.Counselor, PlayLuteMinor_OnCommand);
			CommandSystem.Register("PlayLapHarp", AccessLevel.Counselor, PlayLapHarp_OnCommand);
			CommandSystem.Register("PlayLapHarpMinor", AccessLevel.Counselor, PlayLapHarpMinor_OnCommand);
		}
		...
		public static void Play_OnCommand(CommandEventArgs e)
		{
			...
			BaseInstrument.PickInstrument(e.Mobile, OnPickedInstrument);
		}
		...
		public class MobilePlayTimer : Timer
		{
			...
			private readonly XmlMusic m_Xm;
