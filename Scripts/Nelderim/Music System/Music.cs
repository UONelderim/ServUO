...
namespace Server.Misc
{
	...
	public class Music
	{
		...
		public static void PlayNotes(Mobile from, string[] notes, BaseInstrument[] instruments)
		{
			try
			{
				if (from == null || instruments == null || notes == null || notes.Length == 0 ||
				    instruments.Length == 0) return;
		...
		private static readonly int[][] NoteSounds =
		{
			// Each array represents the sounds for each note on harp, lap harp, lute, and drums(hits)
			new[] { 1181, 976, 1028, 310 }, // c_low
			new[] { 1184, 979, 1031, 311 }, // c_sharp_low
			new[] { 1186, 981, 1033, 312 }, // d
			new[] { 1188, 983, 1036, 313 }, // d_sharp
			new[] { 1190, 985, 1038, 314 }, // e
			new[] { 1192, 987, 1040, 315 }, // f
			new[] { 1194, 989, 1042, 316 }, // f_sharp
			new[] { 1196, 991, 1044, 317 }, // g
			new[] { 1198, 993, 1046, 318 }, // g_sharp
			new[] { 1175, 970, 1021, 319 }, // a
			new[] { 1177, 972, 1023, 320 }, // a_sharp
			new[] { 1179, 974, 1025, 321 }, // b
			new[] { 1182, 977, 1029, 322 }, // c
			new[] { 1185, 980, 1032, 323 }, // c_sharp
			new[] { 1187, 982, 1034, 324 }, // d_high
			new[] { 1189, 984, 1037, 325 }, // d_sharp_high
			new[] { 1191, 986, 1039, 326 }, // e_high
			new[] { 1193, 988, 1041, 327 }, // f_high
			new[] { 1195, 990, 1043, 328 }, // f_sharp_high
			new[] { 1197, 992, 1045, 329 }, // g_high
			new[] { 1199, 994, 1047, 330 }, // g_sharp_high
			new[] { 1176, 971, 1022, 331 }, // a_high
			new[] { 1178, 973, 1024, 950 }, // a_sharp_high
			new[] { 1180, 975, 1026, 951 }, // b_high
			new[] { 1183, 978, 1030, 952 }, // c_high
			new[] { 728, 728, 728, 933 } // pause
		};
	}
}
