...
namespace Scripts.Mythik.Systems.Achievements
{
    public class DiscoveryAchievement : BaseAchievement
    {
        ...
        public DiscoveryAchievement(int id, int catid, int itemIcon, bool secret, BaseAchievement prereq, string title, string desc, ushort points, string region, params Type[] rewards)
