...
namespace Scripts.Mythik.Systems.Achievements
{
	...
	{
		public BaseAchievement(int id, int catid, int itemIcon, bool secret, BaseAchievement prereq, string title,
			string desc, ushort points, int total, params Type[] rewards)
		{
			ID = id;
			CategoryID = catid;
			Title = title;
