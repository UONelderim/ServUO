...
namespace Scripts.Mythik.Systems.Achievements
{
    ...
    {
        private Type m_Item;
        public HarvestAchievement(int id, int catid, int itemIcon, bool secret, BaseAchievement prereq, int total, string title, string desc, ushort points, Type targets, params Type[] rewards)
