...
namespace Scripts.Mythik.Systems.Achievements.AchieveTypes
{
	class SkillProgressAchievement : BaseAchievement
	{
		...
		public SkillProgressAchievement(int id, int catid, int itemIcon, bool secret, BaseAchievement prereq, int total,
			string title, string desc, SkillName skill, ushort points, params Type[] rewards)
