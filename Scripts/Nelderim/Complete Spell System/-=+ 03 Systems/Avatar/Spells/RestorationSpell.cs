...
{
	public class AvatarRestorationSpell : AvatarSpell
	{
		...
		{
			private readonly AvatarRestorationSpell m_Owner;

			public InternalTarget(AvatarRestorationSpell owner) : base(12, false, TargetFlags.Beneficial)
			{
				m_Owner = owner;
			}
