namespace Server.ACC.CSS.Systems.Avatar
{
	public class AvatarInitializer : BaseInitializer
	{
		public static void Configure()
		{
			...
			Register( typeof( AvatarEnemyOfOneSpell ),      "Naznaczony",     
				"Naznacza cel, który będzie otrzymywać więcej obrażeń od Mnicha, lecz mnich otrzymmuje ich więcej od innych celów.",       
				null, "Dziesiecina: 15; Mana: 20; Skill: 45", 2243,  3000, School.Avatar );
