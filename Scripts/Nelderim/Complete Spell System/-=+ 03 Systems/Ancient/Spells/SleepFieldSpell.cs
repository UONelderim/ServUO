	...
	public class AncientSleepFieldSpell : AncientSpell
	{
		...
		private class InternalItem : Item
		{
			...
			public void ApplySleepTo(Mobile m)
			{
				...
				TimeSpan duration =
					TimeSpan.FromSeconds(m_Caster.Skills[SkillName.Magery].Value * 1.2); // 120% of magery
			...
			private class BodyTimer : Timer
			{
				...
				private readonly SleepingBody m_Body;
		...
		{
			private readonly AncientSleepFieldSpell m_Owner;
