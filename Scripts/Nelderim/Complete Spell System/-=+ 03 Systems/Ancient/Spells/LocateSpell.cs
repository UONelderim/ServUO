	...
	public class AncientLocateSpell : AncientSpell
	{
		...
		public override void OnCast()
		{
			if (CheckSequence())
			{
				...
				if (Format(Caster.Location, Caster.Map, ref xLong, ref yLat, ref xMins, ref yMins, ref xEast,
					    ref ySouth))
				{
					string location = String.Format("Your current location is: {0} {1}'{2}, {3} {4}'{5}", yLat, yMins,
						ySouth ? "S" : "N", xLong, xMins, xEast ? "E" : "W");
