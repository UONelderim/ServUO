...
namespace Server.ACC.CSS.Systems.Ancient
{
	public class AncientFalseCoinSpell : AncientSpell
	{
		...
		public void Target(Gold weapon)
		{
			...
			else if (CheckSequence())
			{
				if (Caster.BeginAction(typeof(AncientFalseCoinSpell)))
				{
					...
					Effects.SendMovingParticles(from, to, 0x1EC6, 1, 0, false, false, 33, 3, 9501, 1, 0,
		...
		{
			private readonly AncientFalseCoinSpell m_Owner;
		...
		private class InternalTimer : Timer
		{
			...
			private readonly FakeGold m_Weapon;
