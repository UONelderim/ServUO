...
namespace Server.ACC.CSS.Systems.Cleric
{
	public abstract class ClericSpell : CSpell
	{
        ...
        public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( "Musisz mieć przynajmniej " + RequiredSkill + " Leczenia by aktywować tę umiejętnosć." );
				return false;
			}
			else if ( Caster.TithingPoints < RequiredTithing )
			{
				Caster.SendMessage( "Musisz mieć przynajmniej " + RequiredTithing + " dziesięciny by aktywować tę umiejętnosć." );
				return false;
			}
		...
		public override bool CheckFizzle()
		{
			...
			if ( Caster.Skills[CastSkill].Value < RequiredSkill )
			{
				Caster.SendMessage( "Musisz mieć przynajmniej " + RequiredSkill + " dziesięciny by aktywować tę umiejętnosć.." );
				return false;
			}
