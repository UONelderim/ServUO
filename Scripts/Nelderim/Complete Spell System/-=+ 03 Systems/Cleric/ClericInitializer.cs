...
namespace Server.ACC.CSS.Systems.Cleric
{
	public class ClericInitializer : BaseInitializer
	{
		public static void Configure()
		{
			...
			Register( typeof( ClericSacredBoonSpell ),    "Święty znak",     "Otoczeni przez magię wydobywajacą się z magicznego znaku, jesteście leczeni przezeń.",                                                                        null, "Mana: 11; Skill: 25; Tithing: 15",  20742, 3500, School.Cleric );
