	...
	public class QuestGiver : Mobile
	{
		...
		public override bool OnDragDrop(Mobile from, Item dropped)
		{
			...
			if ( mobile != null)
			{
					...
					this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "Kiedy skonczysz, zwroc mi pergamin z misja... by otrzymac swoja nagrode.", mobile.NetState );
         				return true;
         			}
					...
					this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "Kiedy skonczysz, zwroc mi pergamin z misja... by otrzymac swoja nagrode.", mobile.NetState );
         			...
         			{
					this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "To nie jest kwota, ktorej szukam.", mobile.NetState );
         				return false;
         			}
					...
					QuestScroll m_Quest = (QuestScroll)dropped;
						...
						this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "Nie ukonczyles tego zadania.", mobile.NetState );
         					return false;
         				}
				...
				{
					mobile.AddToBackpack ( dropped );
					this.PrivateOverheadMessage(MessageType.Regular, 1153, false, "Tego nie potrzebuje...", mobile.NetState); return true;
				}
			}
