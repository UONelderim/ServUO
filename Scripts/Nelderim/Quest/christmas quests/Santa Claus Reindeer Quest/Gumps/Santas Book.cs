...
namespace Server
{
	public class SantasBookGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(35, 83, 346, 281,
				@"<BODY>Znajdź i oswój każdego z reniferów i zwróć je Mikołajowi. Po prostu powiedz „Panie”, aby zwrócić jego uwagę. Wynagrodzi twoje wysiłki, podobnie jak jego zgubiony renifer.
...
Baw się i niech Twoje Święta będą wypełnione szczęściem! - Elfy
			...
			AddHtml(35, 285, 346, 281,
				@"<BODY>Użyj tej listy kontrolnej, aby śledzić, które z reniferów Pana zostały oswojone. Nie zamykaj tej książki, w przeciwnym razie znaczniki wyboru zostaną utracone. - Elfy</BODY>",
				false, true);
