...
namespace Server.Mobiles
{
	public class SantaClaus : BaseCreature
	{
		...
		[Constructable]
		public SantaClaus() : base(AIType.AI_Melee, FightMode.None, 10, 1, 0.4, 1.6)
			...
			if (mobile != null)
			{
...

				{
					if (dropped.Amount != 1)
					{
						...
						this.PrivateOverheadMessage(MessageType.Regular, 1153, false, "Nie musze tego robic.",
							mobile.NetState);
						this.PrivateOverheadMessage(MessageType.Regular, 1153, false,
							"Wolalbym prezent od mojego renifera " + dropped.Amount + ".", mobile.NetState);
