...
{
	public class Snowpile2010 : Item
	{
		[Constructable]
		...
		public Snowpile2010(Serial serial) : base(serial)
		{
		}
		...
		private class SnowTarget : Target
		{
			...
			private readonly Snowpile2010 m_Snow;

			public SnowTarget(Mobile thrower, Snowpile2010 snow) : base(10, false, TargetFlags.None)
			{
				m_Thrower = thrower;
				m_Snow = snow;
			}
