...
{
	public class Snowpile2011 : Item
	{
		[Constructable]
		public Snowpile2011() : base(0x913)
		{
			Hue = 1151;
			Name = "wyrzutnia sniezek";
			LootType = LootType.Blessed;
			m_NextAbilityTime = DateTime.Now;
		}

		public Snowpile2011(Serial serial) : base(serial)
		{
		}
		...
		private class SnowTarget : Target
		{
			...
			private readonly Snowpile2011 m_Snow;

			public SnowTarget(Mobile thrower, Snowpile2011 snow) : base(10, false, TargetFlags.None)
			{
				m_Thrower = thrower;
				m_Snow = snow;
			}
