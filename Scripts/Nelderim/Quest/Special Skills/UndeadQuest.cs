...
{
    public class UndeadQuest : BaseQuest
    {
        public UndeadQuest()
            : base()
        {
  ...
  */
    ...
    public class UndeadPhase2Quest : BaseQuest
    {
        public UndeadPhase2Quest()
            : base()
        {
	        AddObjective(new DeliverObjective(typeof(SpidersSilk),"Pajecza siec",100,typeof(CityRegion),"Tasandora"));
	        AddObjective(new DeliverObjective(typeof(DestroyingAngel),"Niszczejacy aniol",100,typeof(CityRegion),"Tasandora"));
    ...
    public class UndeadPhase4Quest : BaseQuest
    {
            ...
            : base()
        {
	        ...
	        AddObjective(new DeliverObjective(typeof(BonerPowder),"Proch kościeja",1,typeof(CityRegion),"Tasandora"));
    ...
    public class UndeadPhase5Quest : BaseQuest
    {
            ...
            : base()
        {
            ...
            AddReward(new BaseReward(typeof(UndeadSpellbook), "Księga Podstępnych Sztuczek")); // Księga Podstępnych Sztuczek
        }
