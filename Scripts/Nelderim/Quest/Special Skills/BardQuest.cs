...
{
    public class BardQuest : BaseQuest
    {
        public BardQuest()
            : base()
        {
	        AddObjective(new DeliverObjective(typeof(AdmiralsHeartyRum),"krasnoludzki rum",1,typeof(CityRegion),"Tasandora"));
    ...
    public class BardPhase2Quest : BaseQuest
    {
            ...
            : base()
        {
	        ...
	        AddObjective(new DeliverObjective(typeof(ZapomnianaPiesn),"Zapomniana piesn",1,typeof(CityRegion),"Tasandora"));
        ...
        /* CChcesz wiedziec wiecej na temat tych slawnych piesi... TO ja ich nie znam. Znal je Odon.. ehh... Odon jak zwykle wieczor spedzal w Karczmie.
         ...
         Podobno gdzies na bagnach zlodzieje ukryli skradzione zloto, oraz ostatni egzemplarz piesni. Ponoc tam bylo 5000 centarow. */ //TODO: Na bagnach kolo Ophi dac spawn piesni
