...
{
    public class AncientQuest : BaseQuest
    {
        public AncientQuest()
            : base()
        {
    ...
    public class AncientPhase2Quest : BaseQuest
    {
        public AncientPhase2Quest()
            : base()
        {
	        AddObjective(new DeliverObjective(typeof(KostkaAncientQuestItem),"Pierwsza Czesc Starozytnej Kosci",1,typeof(DungeonRegion),"Labitynt"));
...
właściwą: W Labiryncie Minotaurów ponoc slyszano o tym, ze owa kostka moze byc. Sprawdz to miejsce. */
    ...
    public class AncientPhase3Quest : BaseQuest
    {
        public AncientPhase3Quest()
            : base()
        {
	        AddObjective(new DeliverObjective(typeof(KostkaAncientQuestItem2),"Druga Czesc Starozytnej Kosci",1,typeof(DungeonRegion),"Labitynt"));
