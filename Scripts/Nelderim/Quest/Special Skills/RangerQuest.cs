...
{
    public class RangerQuest : BaseQuest
    {
        public RangerQuest()
            : base()
        {
 ...
 */ //
    ...
    public class RangerPhase4Quest : BaseQuest
    {
            ...
            : base()
        {
	        ...
	        AddObjective(new DeliverObjective(typeof(ZoogiFungus),"grzyby zoogi",200,typeof(CityRegion),"Tasandora"));
    ...
    public class RangerPhase5Quest : BaseQuest
    {
            ...
            : base()
        {
            ...
            AddReward(new BaseReward(typeof(RangerSpellbook), "Poradnik Strażnika Leśnegoh")); // Poradnik Strażnika Leśnego
        }
