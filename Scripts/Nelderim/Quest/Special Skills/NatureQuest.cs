...
{
    public class NatureQuest : BaseQuest
    {
        public NatureQuest()
            : base()
        {
    ...
    public class NaturePhase4Quest : BaseQuest
    {
        public NaturePhase4Quest()
            : base()
        {
	        AddObjective(new SlayObjective(typeof(GargoyleEnforcer), "gargulec niewolnik", 10, "VelkynAto_VeryDifficult"));
    ...
    public class NaturePhase5Quest : BaseQuest
    {
        public NaturePhase5Quest()
            : base()
        {
            AddObjective(new ObtainObjective(typeof(GreaterHealScroll), "Zwoj Wiekszego Leczenia (Greater Heal)", 20, 0x1F49));
