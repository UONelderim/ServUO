...
{
    public class AvatarQuest : BaseQuest
    {
        public AvatarQuest()
            : base()
        {
    ...
    public class AvatarPhase2Quest : BaseQuest
    {
        public AvatarPhase2Quest()
            : base()
        {
	        AddObjective(new DeliverObjective(typeof(PowerCrystal),"Krysztal mocy",10,typeof(DungeonRegion),"SwiatyniaStworzenia"));
...
Swiatyni Stworzenia w Tasandorze i dostarczyc tam 10 krysztalow mocy.. */
    ...
    public class AvatarPhase5Quest : BaseQuest
    {
        public AvatarPhase5Quest()
            : base()
        {
            AddObjective(new ObtainObjective(typeof(GreaterHealScroll), "Zwoj Wiekszego Leczenia (Greater Heal)", 30, 0x1F49));
