namespace Server.Items.Crops
{
	...
	public class WeedPlantZbieractwo : WeedPlant
	{
		...
		public override string MsgPlantTooYoung
		{
			get { return "Ilosc surowca w tym miejscu nie jest jeszcze wystarczajaca."; }
		}

		public override string MsgNoChanceToGet
		{
			get { return "Twoja wiedza o tym surowcu jest za mala, aby go wykorzystac."; }
		}
