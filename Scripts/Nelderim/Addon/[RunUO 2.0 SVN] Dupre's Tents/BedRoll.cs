...
namespace Server.Items
{
	...
	{
		[Constructable]
		public TentDestroyer(TentWalls tentwalls, TentRoof tentroof, TentFloor tentfloor, TentTrim tenttrim,
			PlayerMobile player, SecureTent chest) :
		...
		[Constructable]
		public TentDestroyer(TentWalls tentwalls, TentRoof tentroof, TentFloor tentfloor, TentTrim tenttrim,
			PlayerMobile player, SecureTent chest, TentVerifier tentverifier)
		{
 ...
 */
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			if (Player == null || Player.Deleted) this.Delete();
		}
	}
}
