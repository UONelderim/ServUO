...
namespace Server.Items
{
	...
	{
		public override BaseAddon
			Addon { get { return null; } } //Oddawaj Deed Po Zrombaniu (powiazania z GardenGroundAddon)
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			if (info.ButtonID >= 1)
			{
				...
				if (res == AddonFitResult.Valid)
					...
					from.SendMessage("Musisz zamknac wszystkie drzwi w domu.");
	...
	public class GardenGroundPlacedGump : Gump
	{
		...
		public GardenGroundPlacedGump(BaseAddonDeed deed) : base(30, 30)
		{
			...
			AddHtml(15, 50, 420, 185, "<BODY>" +
			                          "<BASEFONT COLOR=YELLOW>Twoj ogród zostal wybudowany!<BR>" +
