...
namespace Arya.Jail
{
	...
	public class JailAccountGump : Gump
	{
		...
		private readonly JailEntry m_ExistingJail;
		...
		private void MakeGump()
		{
			...
			this.AddHtml(30, 100, 259, 60,
				@"<basefont color=#FFFFFF>Do you wish to convert the existing jailing and jail the full account rather than add a new entry?",
				false, false);
