                            ...
                            if (!duplicate)
                            {
                                ...
                                if (sectorList.Count > MaxSmartSectorListSize)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        using (StreamWriter op = new StreamWriter("Logs/badspawn.log", true))
                                        {
...
public static void _TraceEnd(int index)
{
	   if(index < MaxTraces){
                        ...
                        if (entrynode != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (group != bool.Parse(GetText(entrynode["GroupSpawn"], "False")))
                                {
                                    ...
                                    try
                                    {
                                        using (StreamWriter op = new StreamWriter("Logs/badimport.log", true))
                                        {
        ...
        private static bool HasTileSurface(Map map, int X, int Y, int Z)
        {
            ...
            foreach (LandTile tile in map.Tiles.GetLandBlock( X, Y ))
            {
                if (tile.Z + tile.Height == Z)
                    return true;
            }
