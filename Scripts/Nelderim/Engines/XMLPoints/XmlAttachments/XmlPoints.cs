...
namespace Server.Engines.XmlSpawner2
{
	public class XmlPoints : XmlAttachment
	{
		...
		private static bool m_SystemBroadcast = false;
		...
		public static bool AutoResAfterDuel = false;
		...
		public static new void Initialize()
		{
			...
			CommandSystem.Register( "PointsLanguage", AccessLevel.GameMaster, new CommandEventHandler( Language_OnCommand ) );
			CommandSystem.Register( "Challenge", AccessLevel.GameMaster, new CommandEventHandler( Challenge_OnCommand ) );
			...
			CommandSystem.Register( "CheckPoints", AccessLevel.GameMaster, new CommandEventHandler( CheckPoints_OnCommand ) );
			CommandSystem.Register( "TopPlayers", AccessLevel.GameMaster, new CommandEventHandler( TopPlayers_OnCommand ) );
		...
		public static bool AllowChallengeGump(Mobile from, Mobile target)
		{
			...
			if (Region.Find(from.Location, from.Map) is JailRegion || Region.Find(target.Location, target.Map) is JailRegion) return false;
