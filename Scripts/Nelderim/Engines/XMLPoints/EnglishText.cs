...
// basechallengegame.cs
					Add(100000, "Oplata wejsciowa {0} zlota zostala Ci zwrocona."); 
					Add(100001, "Oplata wejsciowa {0} zlota zostala Ci zwrocona do skrzyni w banku."); 
					Add(100002, "Niech gra sie zacznie!"); 
					Add(100003, "{0} anulowane"); 

// challengeregion.cs 
					Add(100104, "Walka nie jest dozwolona przed i po Turnieju."); 
					Add(100105, "Nie mozesz otworzyc tego tutaj."); 
					Add(100106, "Wszedles na obszar Turnieju '{0}'"); 
					Add(100107, "Wyszedles z obszaru Turnieju '{0}'"); 

// xmlpoints.cs 
					Add(100207, "Oni sa zbyt niedoswiadczeni, aby przyjac wyzwanie"); 
					Add(100208, "Pozostalo {0} minut do anulowania wyzwania."); 
					Add(100209, "Anulowanie aktualnego wyzwania. Prosze czekac {0} minut"); 
					Add(100210, "{0} anuluje aktualne wyzwanie. {1} minut pozostalo"); 
					Add(100211, "{0} zaczal juz wyzwanie."); 
					Add(100212, "Nie mozesz wyzwac siebie."); 
					Add(100213, "No XmlPoints support."); 
					Add(100214, "Wyzwanie z {0} zostalo anulowane"); 
					Add(100215, "Otrzymujesz {0} punktow za zabicie {1}"); 
					Add(100216, "{0} pokonal {1} w walce."); 
					Add(100217, "Straciles {0} punktow, przez przegranie z {1}"); 
// xmlpoints identify 
					Add(100218, "Ilosc punktow = {0}"); 
					Add(100219, "Ranking = {0}"); 
					Add(100220, "Bez rankingu"); 
					Add(100221, "Dostepne kredyty = {0}"); 
					Add(100222, "Wszystkie wygrane = {0}\nWszystkie porazki = {1}\nPoprzednia Lista smierci"); 
					Add(100223, "{0} zabity przez {1}"); 
// xmlpoints gump 
					Add(200224, "Pozycja za aktualna liczba punktow: {0}"); 
					Add(200225, "Rzucajacy wyzwanie {0}"); 
					Add(200226, "Zobacz zabicia" ); 
					Add(200227, "Audycja zabic"); 
					Add(200228, "Najlepsi gracze"); 
					Add(200229, "Wyzwanie"); 
					Add(200230, "LMS"); 
					Add(200231, "Deathmatch"); 
					Add(200232, "KotH"); 
					Add(200233, "DeathBall"); 
					Add(200234, "Druzyna LMS"); 
					Add(200235, "Druzyna DMatch"); 
					Add(200236, "Druzyna DBall"); 
					Add(200237, "Druzyna KotH"); 
					Add(200238, "CTF"); 
// topplayers gump 
					Add(200239, "Rankingi najlepszych graczy"); 
					Add(200240, "Filtruj wg Gildii"); 
					Add(200241, "Filtruj wg Imion"); 
					Add(200242, "Imie"); 
					Add(200243, "Gildia"); 
					Add(200244, "Punkty"); 
					Add(200245, "Zabicia"); 
					...
					Add(200247, "Ranking"); 
					Add(200248, "Zmiana"); 
					Add(200249, "Czas rankingu" ); 
					Add(200250, "{0} dni " ); 
					Add(200251, "{0} godzin " ); 
					Add(200252, "{0} minut" ); 
					Add(200253, "tylko zmienione" ); 
// challenge gump 
					Add(200254, "Rzucasz wyzwanie" ); 
					Add(200255, "{0}. Kontynuowac?" ); 
					Add(200256, "Nie zdobedziesz zadnych punktow!" ); 
					Add(100257, "Wypowiedziales wyzwanie do {0}." ); 
					Add(100258, "Zdecydowales powtorzyc wyzwanie {0}." ); 
					Add(200259, "Zostales wyzwany przez" ); 
					Add(200260, "{0}. Akceptujesz?" ); 
					Add(100261, "{0} juz zostal wyzwany." ); 
					Add(100262, "Zaczales juz wyzwanie." ); 
					Add(100263, "{0} przyjal twoje wyzwanie!" ); 
					Add(100264, "Zaakceptowales wyzwanie od {0}!" ); 
					Add(100265, "Twoje wyzwanie do {0} zostalo odrzucone." ); 
					Add(100266, "Odrzuciles wyzwanie od {0}." ); 

// gauntlet scripts 
					Add(100300, "Nagroda od {0}" ); 
					Add(100301, "Otrzymales czek bankowy od {0}" ); 
					Add(100302, "Ostatni stojacy czlowiek" ); 
					Add(100303, "Nie mozna zalozyc {0} wyzwania: Inny turniej rozgrywa sie w tym obszarze turnieju."); 
					Add(100304, "Nie mozna zalozyc {0} wyzwania: Musisz znajdowac sie w obszarze turnieju."); 
					Add(100305, "Nie mozna zalozyc {0} wyzwania."); 
					Add(100306, "Zakladanie {0} wyzwania."); 
					Add(100307, "{0} Wyzwanie zostalo przygotowane w '{1}' przez {2}"); 
					Add(100308, "{0} zostales zdyskwalifikowany"); 
					Add(100309, "Jestes poza granica! Masz {0} sekund na powrot"); 
					Add(100310, "Masz {0} sekund, aby wyjsc z ukrycia"); 
					Add(100311, "Wygrales {0}"); 
					Add(100312, "Zwyciezca jest {0}"); 
					Add(100313, "Pojedynek zakonczyl sie remisem"); 
					Add(100314, "{0} zostal zabity"); 
					Add(100315, "wyzwanie od {0}"); 
					Add(100400, "Deathmatch"); 
					Add(100401, "{0} zostal ukarany."); 
					Add(100410, "King of the Hill"); 
					Add(100411, "Deathball"); 
					Add(100412, "{0} upuscil pilke!"); 
					Add(100413, "Druzyna LMS"); 
					Add(100414, "Druzyna {0} jest zwyciezca!"); 
					Add(100415, "Druzyna Deathmatch"); 
					Add(100416, "Druzyna Deathball"); 
					Add(100417, "Druzyna KotH"); 
					Add(100418, "Przejecie flagi"); 
					Add(100419, "Druzyna {0} zwrocila flage do bazy"); 
					Add(100420, "Druzyna {0} ma flage druzyny {1}"); 
					Add(100421, "Druzyna {0} zdobywa punkt"); 

// game gump scripts 
					Add(200500, "Wyzwanie – Ostatni Stojacy Czlowiek"); 
					Add(200501, "Zorganizowany przez: {0}"); 
					Add(200502, "Oplata wejsciowa: {0}"); 
					Add(200503, "Rozmiar Areny: {0}"); 
					Add(200504, "Pula nagrod: {0}"); 
					Add(200505, "Miejsce: {0} {1}"); 
					Add(200506, "Gracze: {0}"); 
					Add(200507, "Aktywnosc: {0}"); 
					Add(200508, "Strona: {0}/{1}"); 
					Add(200509, "Czekac"); 
					Add(200510, "Zaakceptowane"); 
					Add(200511, "Braki pokrycia"); 
					Add(200520, "Grzywna"); 
					Add(200521, "Ukryty"); 
					Add(200522, "Poza granicami"); 
					Add(200523, "Wylogowany"); 
					Add(200524, "Zwyciezcy"); 
					Add(200525, "Aktywnosc"); 
					Add(200526, "smierc"); 
					Add(200527, "Zdyskwalifikowani"); 
					Add(200528, "Dodaj"); 
					Add(200529, "Start"); 
					Add(200530, "Oplata wejsciowa: "); 
					Add(200531, "Rozmiar areny: "); 
					Add(200532, "Odswiez"); 
					Add(200533, "Trwa Gra!"); 
					Add(200534, "{0} jest zwyciezca!"); 
					Add(100535, "Wyzwanie jest Pelne!"); 
					Add(100536, "{0} nie kwalifikuje sie. Bez punktu."); 
					Add(100537, "{0} jest juz w wyzwaniu."); 
					Add(100538, "{0} nie moze uiscic oplaty wejsciowej."); 
					Add(100539, "{0} nie zaakceptowal jeszcze."); 
					Add(100540, "Niewystarczajaca ilosc graczy."); 
					Add(100541, "Nie mozna zrealizowac oplaty wejsciowej w wysokosci {0} zlota z twojej skrzyni bankowej."); 
					Add(100542, "Oplata wejsciowa w wysokosci {0} zlota zostala zrealizowana z twojej skrzyni bankowej."); 
					Add(100543, "Spadles ponizej {0}"); 
					Add(100544, "{0} odpadl."); 
					Add(100545, "Zostales wykopany z {0}"); 
					Add(100546, "{0} nie kwalifikuje sie. Bez punktu."); 
					Add(100547, "{0} jest juz w wyzwaniu."); 
					Add(100548, "{0} zostal juz dodany do gry."); 
					Add(100549, "Dodales {0} do wyzwania."); 
					Add(100550, "Zostales zaproszony do uczestnictwa w {0}."); 
					Add(200560, "Wyzwanie Deathmatch"); 
					Add(200561, "Wynik celu: {0}"); 
					Add(200562, "Wynik celu: Zero"); 
					Add(200563, "Legenda Meczu: {0}"); 
					Add(200564, "Legenda Meczu: Calosc"); 
					Add(200565, "Pozostaly czas {0}"); 
					Add(200566, "Wynik: "); 
					Add(200567, "Min. dlugosc: "); 
					Add(100568, "Brak odpowiednich warunkow do rozstrzygniecia meczu."); 
					Add(200570, "Wyzwanie druzyny Deathball"); 
					Add(200572, "Oplata: "); 
					Add(200573, "Rozm. Areny: "); 
					Add(200580, "Wyzwanie King of the Hill"); 
					Add(200590, "Wyzwanie druzyny Deathmatch"); 
					Add(200591, "Druzyna"); 
					Add(200592, "Druzyny"); 
					Add(200593, "Druzyna {0} jest zwyciezca!"); 
					Add(100594, "{0} nie bedzie wyznaczal druzyny."); 
					Add(200595, "Status druzyny Deathmatch"); 
					Add(200596, "Gracze"); 
					Add(200597, "Dzialanie"); 
					Add(200598, "Wynik"); 
					Add(200600, "Wyzwanie druzyny KotH"); 
					Add(200601, "Status druzyny KotH"); 
					Add(200610, "Wyzwanie druzyny LMS"); 
					Add(200611, "Status druzyny LMS"); 
					Add(200620, "Wyzwanie Capture the Flag"); 
					Add(100621, "Baza druzyny {0} nieokreslona."); 
					Add(200622, "Baza"); 
					Add(200623, "Status druzyny CTF"); 
					Add(200630, "Wyzwanie druzyny Deathball"); 
					Add(200631, "Status druzyny Deathball"); 

					Add(200640, "Frakcja"); 
					Add(200649, "Lokacja: {0}"); 
					Add(200650, "{0} jest zajmowany"); 

					Add(200660, "Anuluj"); 
					Add(200661, "Pojedynek tutaj"); 
					Add(100670, "{0} jest w trakcie walki."); 
