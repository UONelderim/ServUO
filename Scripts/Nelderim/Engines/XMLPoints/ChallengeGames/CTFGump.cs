...
namespace Server.Gumps
{
	public class CTFGump : Gump
	{
		...
		public CTFGump(CTFGauntlet gauntlet, Mobile from) : this(gauntlet, from, 0)
		{
		}

		public CTFGump(CTFGauntlet gauntlet, Mobile from, int page) : base(20, 30)
		{
		...
		private class MemberTarget : Target
		{
			...
			public MemberTarget(CTFGauntlet gauntlet, ArrayList list) : base(30, false, TargetFlags.None)
			{
				m_list = list;
				m_gauntlet = gauntlet;
			}
		...
		private class CTFBaseTarget : Target
		{
			...
			public CTFBaseTarget(CTFGauntlet gauntlet, int team) : base(30, true, TargetFlags.None)
			{
				m_team = team;
				m_gauntlet = gauntlet;
			}
		...
		public class TeamsGump : Gump
		{
			...
			public TeamsGump(CTFGauntlet gauntlet, Mobile from) : base(350, 30)
			{
				m_gauntlet = gauntlet;
