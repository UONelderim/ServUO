...
namespace Server.Engines.XmlSpawner2
{
    ...
    public class SpanishPointsText
    {
    	...
    	public static void Initialize()
    	{
            ...
            // challengeregion.cs
            Add(100104, "No sera permitido hacer dano antes o despues de un desafio.");
            ...
            Add(100548, "{0} ya ha sido anadido al juego.");
            Add(100549, "Tu anadistes a {0} para el challenge.");
