...
namespace Server.Engines.XmlSpawner2
{
    ...
    public class PortuguesePointsText
    {
    	...
    	public static void Initialize()
    	{
            ...
            Add(100000, "A taxa de entrada de {0} moedas de ouro foram retornadas para voce.");
            Add(100001, "A taxa de entrade de {0} foi depositada em seu banco.");
            Add(100002, "Que comessem os jogos!");
            Add(100003, "{0} cancelado");

            // challengeregion.cs
            Add(100104, "Atos de violencia não são permitos antes ou depois do duelo.");
            Add(100105, "Voce não autorização para abrir aquilo aqui.");
            Add(100106, "Voce entrou na arena de Jogos '{0}'");
            Add(100107, "Voce deixou a arena de jogos '{0}'");
            
            // xmlpoints.cs
            Add(100207, "Eles possuem muita experiencia para serem desafiados.");
            ...
            Add(100212, "Voce não pode desafiar voce mesmo.");
            Add(100213, "PVP não suportado.");
            Add(100214, "Desafio com {0} foi cancelado");
            Add(100215, "Voce recebeu {0} pontos por matar {1}");
            Add(100216, "{0} derrotou {1} em combate.");
            Add(100217, "Voce perdeu {0} ponto(s) por ter sido derrotado por {1}");
            // xmlpoints identify
            ...
            // challenge gump
            Add(200254, "Voce está desafiando" );
            Add(200255, "{0}. Continuar?" );
            Add(200256, "Voce não vai ganhar pontos!" );
            Add(100257, "Voce propôs um desafio {0}." );
            Add(100258, "Voce decidiu por desafiar {0}." );
            Add(200259, "Voce esta sendo desafiado por" );
            Add(200260, "{0}. Aceitar?" );
            Add(100261, "{0} já está sendo desafiado." );
            Add(100262, "Voce já está sendo desafiado." );
            Add(100263, "{0} aceitou seu desafio!" );
            Add(100264, "Voce aceitou o desafio de {0}!" );
            Add(100265, "Sua proposta de desafiar {0} foi recusada." );
            Add(100266, "Voce recusou o desafio de {0}." );
			Add(100267, "Voce não pode emitir um desafio aqui.");

            // gauntlet scripts
            Add(100300, "Premio por {0}" );
            Add(100301, "Voce recebeu um cheque por {0}" );
            Add(100302, "Survivor!" );
            ...
            Add(100309, "Voce está fora dos limitas da arena!  Voce tem {0} segundos para retornar.");
            Add(100310, "Voce tem {0} para se mostrar");
            Add(100311, "Voce venceu {0}");
            ...
            Add(100543, "Voce desistiu do {0}");
            Add(100544, "{0} desiste.");
            Add(100545, "Voce foi expulsso do {0}");
            Add(100546, "{0} does not qualify. No points support.");
            Add(100547, "{0} já está em um desafio.");
            Add(100548, "{0} já foi adicionado ao jogo.");
            Add(100549, "Voce adicionou {0} ao desafio.");
            Add(100550, "Voce foi convidado a participar do desafio: {0}.");
