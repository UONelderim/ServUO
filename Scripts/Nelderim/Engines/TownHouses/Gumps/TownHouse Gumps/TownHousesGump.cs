...
namespace Knives.TownHouses
{
    public class TownHousesGump : GumpPlusLight
    {
        ...
        {
            CommandSystem.Register("TownHouses", AccessLevel.Counselor, new CommandEventHandler(OnHouses));
        }
        ...
        private void HouseMenu(object obj)
        {
            ...
            Owner.SendGump(new HouseGump((HouseGumpPage)0, Owner, (BaseHouse)obj));
        }
