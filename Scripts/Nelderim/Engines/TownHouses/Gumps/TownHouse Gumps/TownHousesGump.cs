...
namespace Knives.TownHouses
{
	public class TownHousesGump : GumpPlusLight
	{
		...
		{
			CommandSystem.Register("TownHouses", AccessLevel.Counselor, OnHouses);
		}

		private static void OnHouses(CommandEventArgs info)
		{
		...
		protected override void BuildGump()
		{
			...
			AddButton(width / 2 - 100, y + 3, c_ListPage == ListPage.Town ? 0x939 : 0x2716, "Page", Page,
				ListPage.Town);
			AddButton(width / 2 + 90, y + 3, c_ListPage == ListPage.House ? 0x939 : 0x2716, "Page", Page,
				ListPage.House);
