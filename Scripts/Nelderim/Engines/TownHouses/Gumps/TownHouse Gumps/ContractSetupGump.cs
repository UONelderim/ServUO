...
namespace Knives.TownHouses
{
	public class ContractSetupGump : GumpPlusLight
	{
		...
		private void FloorsPage(int width, ref int y)
		{
			...
			if (c_Contract.MinZ != Int16.MinValue)
			{
		...
		private void EntireHouse()
		{
			...
			else
			{
				...
				c_Contract.MinZ = Int16.MinValue;
				c_Contract.MaxZ = Int16.MinValue;
			}
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(ContractSetupGump gump, RentalContract contract, TargetType type) : this(gump,
				contract, type, Point3D.Zero)
			{
			}
			...
			protected override void OnTarget(Mobile m, object o)
			{
				...
				switch (c_Type)
				{
					...
					case TargetType.BlockTwo:
						Rectangle2D rect = TownHouseSetupGump.FixRect(new Rectangle2D(c_BoundOne,
