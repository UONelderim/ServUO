...
namespace Server.Items
{
	...
	{
		private static readonly string m_ArmedName = "uzbrojona powiększa zamrażająca pułapka";
		private static readonly string m_UnarmedName = "nieuzbrojona powiększa zamrażająca pułapka";
