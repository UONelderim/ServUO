...
namespace Server.Items
{
	...
	{
		private static readonly string m_ArmedName = "uzbrojona trująca pułapka z lekką trucizną";
		private static readonly string m_UnarmedName = "nieuzbrojona trująca pułapka z lekką trucizną";
		private static readonly double m_ExpiresIn = 120.0;
		private static readonly int m_ArmingSkill = 25;
		private static readonly int m_DisarmingSkill = 30;
