...
namespace Server.Items
{
	...
	{
		private static readonly string m_ArmedName = "uzbrojona trująca pułapka ze śmiertelną trucizną";
		private static readonly string m_UnarmedName = "nieuzbrojona trująca pułapka ze śmiertelną trucizną";
