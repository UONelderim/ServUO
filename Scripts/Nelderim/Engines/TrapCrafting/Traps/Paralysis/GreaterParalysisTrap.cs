...
namespace Server.Items
{
	...
	{
		private static readonly string m_ArmedName = "uzbrojona powiększa paraliżująca pułapka";
		private static readonly string m_UnarmedName = "nieuzbrojona powiększa paraliżująca pułapka";
