...
namespace Server.Items
{
	...
	{
		private static readonly string m_ArmedName = "uzbrojona pomniejsza porażająca pułapka";
		private static readonly string m_UnarmedName = "nieuzbrojona pomniejsza porażająca pułapka";
