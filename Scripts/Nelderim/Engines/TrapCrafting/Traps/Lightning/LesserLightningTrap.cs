...
namespace Server.Items
{
    public class LightningLesserTrap : BaseTinkerTrap
    {
        ...
        private static string m_ArmedName = "uzbrojona pomniejsza porażająca pułapka";
        private static string m_UnarmedName = "nieuzbrojona pomniejsza porażająca pułapka";
