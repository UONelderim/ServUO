...
namespace Server.Engines.Apiculture
{
	public class apiBeeHiveMainGump : Gump
	{
		...
		public apiBeeHiveMainGump(Mobile from, apiBeeHive hive) : base(20, 20)
		{
			...
			if (hive.HiveStage >= HiveStatus.Producing)
				AddLabel(90, 42, 92, "Kolonia : " + hive.Population + "0k");
			...
			switch (hive.OverallHealth) //overall health
			{
				case HiveHealth.Dying:
					AddLabel(116, 146, 37, "Umierajace");
					break;
				case HiveHealth.Sickly:
					AddLabel(116, 146, 52, "Chore");
					break;
				case HiveHealth.Healthy:
					AddLabel(116, 146, 67, "Zdrowe");
					break;
				case HiveHealth.Thriving:
					AddLabel(116, 146, 92, "Prosperujace");
					break;
			}
	...
	public class apiBeeHiveProductionGump : Gump
	{
		...
		public apiBeeHiveProductionGump(Mobile from, apiBeeHive hive) : base(20, 20)
		{
			...
			AddLabel(47, 60, 92, "Powiekszony wplyw kwiatow: " + m_hive.FlowersPower);
			...
			AddLabel(90, 150, 70 + 10 * (int)m_hive.FlowersQuarter, "Miod: " + m_hive.FlowersQuarter); //rodzaj miodu
		}
