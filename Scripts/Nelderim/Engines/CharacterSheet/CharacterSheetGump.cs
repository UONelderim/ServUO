...
namespace Nelderim
{
    ...
    public class CharacterSheetGump : Gump {
        ...
        public CharacterSheetGump(Mobile from, Mobile target, CSPages page, bool gmRequested)
            ...
            switch (page) {
                ...
                case CSPages.General: {
                        ...
                        AddLabel(15, 140, 200, string.Format("Miasto: {0}", TownDatabase.GetCitizenCurrentCity(m_Target) == Towns.Towns.None ? "brak" : TownDatabase.GetCitizenCurrentCity(m_Target).ToString()));
                        ...
                        AddRadioButton(15, 240, GetButtonID(1, 1, gmRequested), "Tak", m_CharacterSheetInfo.AttendenceInEvents);
                        AddRadioButton(93, 240, GetButtonID(1, 2, gmRequested), "Nie", !m_CharacterSheetInfo.AttendenceInEvents);

                        AddLabel(15, 260, 200, string.Format("Preferowany czas eventow: "));
                        AddRadioButton(15, 280, GetButtonID(1, 3, gmRequested), "30min", m_CharacterSheetInfo.EventFrequencyAttendence == EventFrequency.F30M);
                        AddRadioButton(93, 280, GetButtonID(1, 4, gmRequested), "60min", m_CharacterSheetInfo.EventFrequencyAttendence == EventFrequency.F60M);
                        AddRadioButton(170, 280, GetButtonID(1, 5, gmRequested), "90min", m_CharacterSheetInfo.EventFrequencyAttendence == EventFrequency.F90M);
                        AddRadioButton(242, 280, GetButtonID(1, 6, gmRequested), "dluzsze", m_CharacterSheetInfo.EventFrequencyAttendence == EventFrequency.FLonger);
                        ...
                        AddLabel(5, 325, 200, string.Format("Czas przydzielenia punktow {0}", m_CharacterSheetInfo.LastQuestPointsTime));
                        ...
                        if (m_From.AccessLevel >= AccessLevel.Counselor) {
                            ...
                            if (m_From.AccessLevel >= AccessLevel.GameMaster) {
                                AddPageButton(75, 380, GetButtonID(2, 10, gmRequested), "-10", page, CSPages.CharacterSheetSave);
                                AddPageButton(75, 400, GetButtonID(2, 15, gmRequested), "-15", page, CSPages.CharacterSheetSave);
                                AddPageButton(75, 420, GetButtonID(2, 20, gmRequested), "-20", page, CSPages.CharacterSheetSave);
                            }

                            if (CanAssignQuestPoints(m_TargetPlayer)) {
                                AddPageButton(200, 380, GetButtonID(3, 1, gmRequested), "+1", page, CSPages.CharacterSheetSave);
                                AddPageButton(200, 400, GetButtonID(3, 3, gmRequested), "+3", page, CSPages.CharacterSheetSave);
                                AddPageButton(200, 420, GetButtonID(3, 5, gmRequested), "+5", page, CSPages.CharacterSheetSave);

                                if (m_From.AccessLevel >= AccessLevel.GameMaster) {
                                    AddPageButton(260, 380, GetButtonID(3, 10, gmRequested), "+10", page, CSPages.CharacterSheetSave);
                                    AddPageButton(260, 400, GetButtonID(3, 15, gmRequested), "+15", page, CSPages.CharacterSheetSave);
                                    AddPageButton(260, 420, GetButtonID(3, 20, gmRequested), "+20", page, CSPages.CharacterSheetSave);
                                }
                            }
                        }
                        break;
        ...
        public override void OnResponse(Server.Network.NetState sender, RelayInfo info) {
            ...
            switch (type) {
                case 0: {
                        ...
                        book.Visible = false;
                        book.Movable = false;
                        book.MoveToWorld(new Point3D(m_FromPlayer.Location.X, m_FromPlayer.Location.Y, m_FromPlayer.Location.Z - 100), m_FromPlayer.Map);
                ...
                case 1: {
                        switch (index) {
                            case 1: m_CharacterSheetInfo.AttendenceInEvents = true; break;
                            case 2: m_CharacterSheetInfo.AttendenceInEvents = false; break;
                            case 3: m_CharacterSheetInfo.EventFrequencyAttendence = EventFrequency.F30M; break;
                            case 4: m_CharacterSheetInfo.EventFrequencyAttendence = EventFrequency.F60M; break;
                            case 5: m_CharacterSheetInfo.EventFrequencyAttendence = EventFrequency.F90M; break;
                            case 6: m_CharacterSheetInfo.EventFrequencyAttendence = EventFrequency.FLonger; break;
                            default: break;
                        }
                ...
                case 2: {
                        ...
                        m_TargetPlayer.SendMessage(0x26, "Twoje saldo punktow fabularnych zostalo zmniejszone przez Mistrza Gry");
        ...
        public void TextEntryChangedCallback(Mobile from, object[] args, string text) {
            ...
            switch (page) {
               case CSPages.Cele: info.AppearanceAndCharacteristic = text; break;
               case CSPages.Historia: info.HistoryAndProfession = text; break;
            }
        }
