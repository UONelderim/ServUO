...
namespace Server.SicknessSys.Gumps
{
    public class PowerGump : Gump
    {
        ...
        public PowerGump(PlayerMobile pm, VirusCell cell, int beat, int x = 25, int y = 25, bool IsBeat = false) : base( x, y)
        {
            if (pm != null)
            {
                ...
                if (cell.Level < 10)
                    AddLabel(x + 29 + Mod41, y + 16, LabelHue, "" + cell.Level.ToString() );
                else if (cell.Level < 100)
                    AddLabel(x + 25 + Mod41, y + 16, LabelHue, "" + cell.Level.ToString() );
                else
                    AddLabel(x + 21 + Mod41, y + 16, LabelHue, "" + cell.Level.ToString() );
