...
namespace Server.SicknessSys.Illnesses
{
    ...
    {
        private static List<string> ColdNames = new List<string>();
        ...
        private static List<string> FluNames = new List<string>();
        ...
        private static List<string> VirusNames = new List<string>();
        ...
        private static List<string> VampireNames = new List<string>();
        ...
        private static List<string> LycanthropiaNames = new List<string>();
