...
namespace Server.Commands
{
    public class Armia
    {
        ...
        {
            CommandSystem.Register("ArmiaPosterunki", AccessLevel.Player, new CommandEventHandler(ArmiaSpawn_handler));
        }

        [Usage("ArmiaPosterunki")]
        [Description("Wyswietla panel ustawien posterunkow miasta. Wymaga bycia obywatelem miasta oraz posiadania odpowiednich uprawnien (Przywodca lub Glowny Kanclerz lub Kanclerz Armii).")]
