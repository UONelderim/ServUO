...
namespace Server.Gumps
{
    public class TownChangeRelationsGump : Gump
    {
        ...
        private Towns m_fromTown, m_toTown;
            ...
            : base(50, 40)
        {
            ...
            AddLabelCropped(10, 30, 300, 40, SelectedColor, string.Format("Zmiana relacji kosztuje kazdorazowo 1000 zlota."));
            AddLabel(10, 70, SelectedColor, string.Format("Wybierz miasto do zmiany relacji"));
            int yLab = 90;
            int tmpRel = 0;
            foreach (Towns t in TownDatabase.GetTownsNames())
            {
                if (t != m_fromTown && t != Towns.None)
                {
                    ...
                    AddLabel(10, yLab, SelectedColor, string.Format("Relacje z {0} wynosza: {1}. Zmien o:", t.ToString(), tmpRel.ToString()));
                    if (tmpRel > -100)
