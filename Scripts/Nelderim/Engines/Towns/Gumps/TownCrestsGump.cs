...
namespace Nelderim.Towns
{
    public class TownCrestsGump : Gump
    {
        ...
        public void AddButton(int x, int y, int buttonID, bool selected, int betweenButtons)
        {
            ...
            AddButton(x + betweenButtons, y, selected ? 9027 : 9026, selected ? 9027 : 9026, buttonID, GumpButtonType.Reply, 0);
        }
            ...
            : base(50, 40)
        {
            ...
            AddPage(0);
            AddBackground(0, 0, m_CrestSize == CrestSize.Medium ? 110 : 280, m_CrestSize == CrestSize.Medium ? 580 : 690, 5054);
            ...
            {
                AddButton(15 + line * xSeparator, 50 + rowCounter * ySeparator, iStart + i, alreadySelectedCrest == (iStart + i), betweenButtons);
                rowCounter += 1;
