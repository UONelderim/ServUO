...
namespace Server.Gumps
{
    public class TownForeignExchangeGump : Gump
    {
            ...
            : base(50, 40)
        {
            ...
            {
                AddLabel(10, 50, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToBuy[0].ResourceType, TownAnnouncer.ForeignResourcesToBuy[0].Amount));
                AddButton(210, 50, 1, "100");
                AddButton(280, 50, 2, "1000");
                AddLabel(10, 70, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToBuy[1].ResourceType, TownAnnouncer.ForeignResourcesToBuy[1].Amount));
                AddButton(210, 70, 11, "100");
                AddButton(280, 70, 12, "1000");
                AddLabel(10, 90, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToBuy[2].ResourceType, TownAnnouncer.ForeignResourcesToBuy[2].Amount));
            ...
            {
                AddLabel(10, 140, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToSell[0].ResourceType, TownAnnouncer.ForeignResourcesToSell[0].Amount));
                AddButton(210, 140, 31, "10");
                AddButton(280, 140, 32, "100");
                AddLabel(10, 160, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToSell[1].ResourceType, TownAnnouncer.ForeignResourcesToSell[1].Amount));
                AddButton(210, 160, 41, "10");
                AddButton(280, 160, 42, "100");
                AddLabel(10, 180, SelectedColor, string.Format("{0} po cenie {1} za sztuke", TownAnnouncer.ForeignResourcesToSell[2].ResourceType, TownAnnouncer.ForeignResourcesToSell[2].Amount));
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (val < 30)
            {
                ...
                if (m_townM.Resources.HasResourceAmount(TownAnnouncer.ForeignResourcesToBuy[which].ResourceType, howMuch))
                {
                    ...
                    m_townM.Resources.ResourceDecreaseAmount(TownAnnouncer.ForeignResourcesToBuy[which].ResourceType, (int)(howMuch));
                    m_townM.Resources.ResourceIncreaseAmount(TownResourceType.Zloto, (int)(TownAnnouncer.ForeignResourcesToBuy[which].Amount * howMuch));
                }
                else 
                {
            ...
            else
            {
                ...
                if (m_townM.Resources.HasResourceAmount(TownResourceType.Zloto, TownAnnouncer.ForeignResourcesToSell[which - 3].Amount * howMuch / 10))
                {
                    // Sprawdz czy miasto posiada miejsce by pomiescic dodatkowe zasoby
                    if(m_townM.Resources.IsResourceAmountProper(TownAnnouncer.ForeignResourcesToSell[which - 3].ResourceType, (int)(howMuch / 10)))
                    {
                        ...
                        m_townM.Resources.ResourceDecreaseAmount(TownResourceType.Zloto, (int)(TownAnnouncer.ForeignResourcesToSell[which - 3].Amount * howMuch / 10));
                        m_townM.Resources.ResourceIncreaseAmount(TownAnnouncer.ForeignResourcesToSell[which - 3].ResourceType, (int)(howMuch / 10));
                    }
                    else
                    {
