...
namespace Server.Engines.BulkOrders
{
	...
	public class SmallFletcherBOD : SmallBOD //TO BE REMOVED AFTER MIGRATION
	{
		...
		public static double[] m_BowFletchingMaterialChances = new double[]
			{
				0.501812500, // None
		...
		public static double[] m_BowFletchingMaterial2Chances = new double[]
			{
				0.25, // Leather
				0.25, // Gut
				0.25, // Cannabis
		...
		public static SmallFletcherBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						BulkMaterialType check = GetRandomMaterial(BulkMaterialType.OakWood, m_BowFletchingMaterialChances );
						double skillReq = 0.0;

						switch ( check )
						{
							case BulkMaterialType.OakWood: skillReq = 65.0; break;
							case BulkMaterialType.AshWood: skillReq = 75.0; break;
							case BulkMaterialType.YewWood: skillReq = 85.0; break;
							case BulkMaterialType.Heartwood: skillReq = 95.0; break;
							case BulkMaterialType.Bloodwood: skillReq = 99.0; break;
							case BulkMaterialType.Frostwood: skillReq = 99.0; break;
						}
