...
namespace Nelderim
{
    public class LanguagesGump : Gump
    {
        public static void Initialize() {
            CommandSystem.Register("jezyk", AccessLevel.Player, new CommandEventHandler(Jezyk_OnCommand));
        }
        ...
        public LanguagesGump(PlayerMobile from) : base(0, 0) {
            ...
            foreach (Language lang in languages) {
                AddButton(20, y, from.LanguageSpeaking == lang ? 4006 : 4005, 4007, (int)lang + 1, GumpButtonType.Reply, 1);
        ...
        public override void OnResponse(NetState sender, RelayInfo info) {
            ...
            if (buttonID > 0) { // ButtonID 0 to zamkniecie gumpa
                if (from is PlayerMobile) {
                    PlayerMobile pm = (PlayerMobile)from;
