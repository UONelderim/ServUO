...
namespace Xanthos.Utilities
{
	...
	{
		private readonly Item m_ItemToReplace;
		private readonly bool m_CopyDeep;

		public static void Initialize()
		{
			CommandHandlers.Register("ReplaceItem", AccessLevel.GameMaster, ReplaceItem_OnCommand);
