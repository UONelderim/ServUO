...
namespace Xanthos.Utilities
{
	public class NewsGump : Gump
	{
		...
		public static void Initialize()
		{
			...
			CommandHandlers.Register( "MOTDAdmin", AccessLevel.Administrator, new CommandEventHandler( MOTDAdmin_OnCommand ) );
			CommandHandlers.Register( "MOTD", AccessLevel.Player, new CommandEventHandler( MOTD_OnCommand ) );
		}
