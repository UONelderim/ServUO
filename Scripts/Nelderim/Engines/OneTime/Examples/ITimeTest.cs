...
namespace Server
{
	...
	{
		public int
			OneTimeType { get; set; } //This is the getter/setter for the type of timer and is needed for the Interface
		...
		public ITimeTest() : base(0xF07)
		{
			...
			OneTimeType =
				3; //second : <Do Not Use>1 = tick, 2 = millisecond<Do Not Use>, 3 = second, 4 = minute, 5 = hour, 6 = day (Pick a time interval 3-6) <Tick and Milli Removed - CPU HOGS>
		}
		...
		private readonly List<Item> itms = new List<Item>();

		public void
			OneTimeTick() //This is the method that will run when the timer event is raised and is needed for the Interface
		{
			if (Hue == 1175)
				Hue = 1153;
			else
