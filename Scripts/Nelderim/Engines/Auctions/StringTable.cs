...
namespace Arya.Auction
{
	...
	public class StringTable
	{
		...
		public StringTable()
		{
			...
			m_Table.Add(116,
				"The item carried by this check no longer exists due to reasons outside the auction system");
			m_Table.Add(117, "The content of the check has been delivered to your bank box.");
			m_Table.Add(118,
				"Couldn't add the item to your bank box. Please make sure it has enough space to hold it.");
			...
			m_Table.Add(126,
				"Your bid of {0} for {1} didn't meet the reserve and the owner decided not to accept your offer");
			m_Table.Add(127,
			...
			m_Table.Add(128,
				"The auction has been cancelled because the auctioned item has been removed from the world.");
			...
			m_Table.Add(135,
				"The auction system has been stopped and your auctioned item is being returned to you. ({0})");
			m_Table.Add(136,
				"The auction has been cancelled because the auctioned item has been removed from the world.");
