...
namespace Server.Gumps
{
	public class BoardGameWonGump : BoardGameGump
	{
		...
		public BoardGameWonGump(Mobile owner, BoardGameControlItem controlitem)
			: base(owner, controlitem)
		{
			AddLabel(40, 20, 1152, "Gra:");
			AddLabel(140, 20, 1172, _ControlItem.GameName);
			AddLabel(40, 50, 1152, "Gratulacje, wygrałeś grę!!");
            
			//TODO: dodać informację o zdobytych punktach?
