...
{
    // oferuje wybór liczby graczy dla gry
    public class SelectStyleGump : Gump
    {
        ...
        public SelectStyleGump(Mobile owner, BoardGameControlItem controlitem) : base(450, 80)
        {
            ...
            AddLabel(20, 60, 1152, "Liczba graczy (" + _ControlItem.MinPlayers.ToString() + "–" + _ControlItem.MaxPlayers.ToString() + "):");
            ...
            {
                AddLabel(20, 40, 1172, "Wybierz liczbę graczy");
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            try
            {
                ...
                {
                    _ControlItem.CurrentMaxPlayers = Math.Max(
                        Int32.Parse(GetTextField(info, 0)),
                        _ControlItem.Players.Count
                    );
            ...
            {
                from.SendMessage("Nieprawidłowa liczba graczy. Spróbuj ponownie.");
            }
        }
    }
}
