...
namespace Server.Items
{
	public class Skullball : Item
	{
		...
		public void goldteamb()
		{
			...
			if( m_goldscore >= 10)
			{
				...
				if( m_AllowedPlayer2 != null )
					m_AllowedPlayer2.Say( "Zloci wygrali! Finalny wynik to "+ oldgoldscore +" do " + oldsilverscore + ".");
				if( m_AllowedPlayer1 != null )
					m_AllowedPlayer1.Say( "Zloci wygrali! Finalny wynik to "+ oldgoldscore +" do " + oldsilverscore + ".");
			...
			if( m_AllowedPlayer2 != null )
			{
				...
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Zloci wygrali, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
				}
				else if( m_goldscore < m_silverscore )
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Srebrni wygrali, a wynik to " + m_silverscore + " do " + m_goldscore + ".");
				}
				else
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Jest remis, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
				}
			}
			...
			{
				if( m_goldscore > m_silverscore )
					m_AllowedPlayer1.Say( "Zloci wygrali, a wynik to" + m_goldscore + " do " + m_silverscore + ".");
				else if( m_goldscore < m_silverscore )
					m_AllowedPlayer1.Say( "Srebrni wygrali, a wynik to " + m_silverscore + " do " + m_goldscore + ".");
				else
					m_AllowedPlayer1.Say( "Jest remis, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
			}
		}
		...
		public void silverteamb()
		{
			...
			if( m_silverscore >= 10)
			{
				...
				if( m_AllowedPlayer2 != null )
					m_AllowedPlayer2.Say( "Srebrni wygrali! Finalny wynik to "+ oldsilverscore +" do " + oldgoldscore + ".");
				if( m_AllowedPlayer1 != null )
					m_AllowedPlayer1.Say( "Srebrni wygrali! Finalny wynik to "+ oldsilverscore +" do " + oldgoldscore + ".");
			...
			if( m_AllowedPlayer2 != null )
			{
				...
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Zloci wygrali! Finalny wynik to " + m_goldscore + " do " + m_silverscore + ".");
				}
				else if( m_goldscore < m_silverscore )
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
					m_AllowedPlayer2.Say( "Srebrni wygrali! Finalny wynik to " + m_silverscore + " do " + m_goldscore + ".");
				}
				else
				{
					SetHue( m_AllowedPlayer1.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer1, m_AllowedPlayer2.FindItemOnLayer( Layer.OuterTorso ), m_AllowedPlayer2, this ); 
			...
			{
				if( m_goldscore > m_silverscore )
					m_AllowedPlayer1.Say( "Zloci wygrali! Finalny wynik to " + m_goldscore + " do " + m_silverscore + ".");
				else if( m_goldscore < m_silverscore )
					m_AllowedPlayer1.Say( "Srebrni wygrali! Finalny wynik to " + m_silverscore + " do " + m_goldscore + ".");
				else
					m_AllowedPlayer1.Say( "Jest remis, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
			}
		}
			...
			foreach ( Mobile ko in mobs ) 
			{
				if ( ( ko is PlayerMobile ) && ( ko != null )  )
				{
					if ( ko.SolidHueOverride == 2101 || ko.SolidHueOverride == 2125 )
					{
						...
						{
							if( m_AllowedPlayer2 != null )
								ko.SendMessage( ko.SolidHueOverride, "Zloci wygrali! Finalny wynik to"+ m_goldscore +" do " + m_silverscore + ".");
							if( m_AllowedPlayer1 != null )
								ko.SendMessage( ko.SolidHueOverride, "Zloci wygrali! Finalny wynik to "+ m_goldscore +" do " + m_silverscore + ".");
							...
							if( ko.SolidHueOverride == 2125 && m_GiveReward )	//Gold Winners Reward
							{
								if( goldteamcount >= m_GiveRewardMinTeamCount && silverteamcount >= m_GiveRewardMinTeamCount )
								{
									...
									prize.Hue = 2125;
									prize.Name = ( DisplayNameOnReward ? ko.Name + ": " : "" ) + "Zwyciezcy czaszko-pilki *** DRUZYNA ZLOTA *** " + ( DisplayTeamCountOnReward ? "[" + goldteamcount + "kontra" + silverteamcount + "] " : "" ) + ( DisplayDateOnReward ? DateTime.Now.ToString() : "" );
									prize.LootType = LootType.Blessed;
									ko.AddToBackpack( prize );
								}
								else
								{
									ko.SendMessage( 33, "Niewystarczajaca liczba uczestnikow, by zakwalifikowac sie na trofeum." );
								}
							}
						...
						{
							if( m_AllowedPlayer2 != null )
								ko.SendMessage( ko.SolidHueOverride, "Srebrni wygrali! Finalny wynik "+ m_silverscore +" do " + m_goldscore + ".");
							if( m_AllowedPlayer1 != null )
								ko.SendMessage( ko.SolidHueOverride, "Srebrni wygrali! Finalny wynik "+ m_silverscore +" do " + m_goldscore + ".");
							...
							if( ko.SolidHueOverride == 2101 && m_GiveReward )	// Silver Winners Reward
							{
								if( goldteamcount >= m_GiveRewardMinTeamCount && silverteamcount >= m_GiveRewardMinTeamCount )
								{
									Item prize = Loot.RandomStatue();
									prize.Hue = 2101;
									prize.Name = ( DisplayNameOnReward ? ko.Name + ": " : "" ) + "Zwyciezcy czaszko-pilki *** DRUZYNA SREBRNA *** " + ( DisplayTeamCountOnReward ? "[" + silverteamcount + "v" + goldteamcount + "] " : "" ) + ( DisplayDateOnReward ? DateTime.Now.ToString() : "" );
									prize.LootType = LootType.Blessed;
									ko.AddToBackpack( prize );
								}
								else
						...
						if( m_goldscore > m_silverscore )
							ko.SendMessage( ko.SolidHueOverride, "Zloci wygrali, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
						else if( m_goldscore < m_silverscore )
							ko.SendMessage( ko.SolidHueOverride, "Srebrni wygrali, a wynik to " + m_silverscore + " do " + m_goldscore + ".");
						else
							ko.SendMessage( ko.SolidHueOverride, "Remis, a wynik to " + m_goldscore + " do " + m_silverscore + ".");
	...
	public class SkullballEnterGate : Item
	{
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if( p == Point3D.Zero )
			{
				m.SendMessage( "Nie ma ustanowionej destynacji - popros bogow o pomoc." );
				return true;
			}

			if( m.SolidHueOverride == 2125 || m.SolidHueOverride == 2101 )
			{
				m.SendMessage( "Juz bierzesz udzial w grze!" );
				return true;
			}

			if( m.Mounted )
			{
				m.SendMessage( "Zejdz z wierzcha, cepie!" );
				return true;
			}
			...
			if ( m_Team == Team.Gold )
			{
				...
				foreach ( Mobile ko in mobs ) 
				{
					...
					{
						if ( ko.SolidHueOverride == 2101 || ko.SolidHueOverride == 2125 )
							ko.SendMessage( ko.SolidHueOverride, m.Name + " dolaczyl do rozgrywek." );
					}
				}	
			}
			else
	...
	public class SkullballExitGate : Item
	{
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if( p == Point3D.Zero )
			{
				m.SendMessage( "Ojej, brak wyjscia. Popros bogow o pomoc" );
				return false;
			}
				...
				if ( ( ko is PlayerMobile ) && ( ko != null )  )
				{
					if ( ko.SolidHueOverride == 2101 || ko.SolidHueOverride == 2125 )
					{
						if( ko.Location == this.Location )	// Only send the leave message if they use the gate. (we call this wehen the game is over, don't need message then).
							ko.SendMessage( ko.SolidHueOverride, m.Name + " opuscil rozgrywki." );
					}
				}
			}
