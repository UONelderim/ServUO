...
namespace Server.Engines.Harvest
{
	public class Bivalvia : HarvestSystem
	{
		...
		private Bivalvia()
		{
			...
			// The Bivalvia
			shell.EffectActions = new int[]{ 12 };
			shell.EffectSounds = new int[0];
			shell.EffectCounts = new int[]{ 1 };
			...
			res = new HarvestResource[]
				{
					new HarvestResource( 0.0, 0.0, 100.0, 1031008, typeof( BlackPearl ) )
				};
            ...
            shell.BonusResources = new BonusHarvestResource[]
            {
