...
namespace Server.Items
{
	...
	public class AncientSewingKit : BaseTool
	{
		private int m_Bonus;
		...
		public override int LabelNumber { get { return 1049803; } } // starozytne narzedzia krawieckie

		[Constructable]
		public AncientSewingKit(int bonus) : this(bonus, 600) {
		}

		[Constructable]
		public AncientSewingKit(int bonus, int uses) : base(uses, 0x0f52) {
			m_Bonus = bonus;
			Weight = 8.0;
		...
		public AncientSewingKit(Serial serial) : base(serial) {
		}
