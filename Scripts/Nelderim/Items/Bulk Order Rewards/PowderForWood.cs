...
namespace Server.Items
{
	public class PowderForWood : Item
	{
		...
		*/
		...
		{
			private readonly PowderForWood m_Powder;
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				if (targeted is BaseArmor &&
				    (DefCarpentry.CraftSystem.CraftItems.SearchForSubclass(targeted.GetType()) != null))
				{
					...
					else
					{
						from.SendLocalizedMessage(1042001); // That must be in your pack for you to use it.
				         ...
				         (DefCarpentry.CraftSystem.CraftItems.SearchForSubclass(targeted.GetType()) != null ||
				          DefBowFletching.CraftSystem.CraftItems.SearchForSubclass(targeted.GetType()) != null))
				{
