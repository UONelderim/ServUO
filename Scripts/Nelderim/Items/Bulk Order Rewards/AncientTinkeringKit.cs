...
{
	public class AncientTinkeringKit : BaseTool
	{
		private int m_Bonus;
		...
		public override int LabelNumber { get { return 3060094; } } 

		[Constructable]
		public AncientTinkeringKit(int bonus) : this(bonus, 600)
		{
		}

		[Constructable]
		public AncientTinkeringKit(int bonus, int uses) : base(uses, 2550)
		{
			m_Bonus = bonus;
			Weight = 8.0;
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (m_Bonus != 0)
				list.Add(3060040, "3060040", m_Bonus.ToString()); // ~1_skillname~ +~2_val~
		}
