...
namespace Server.Items
{
	...
	public class RodOfResurrection : Scepter
	{
		...
		public void GetDamageTypes( Mobile wielder, out int phys, out int fire, out int cold, out int pois, out int nrgy )
		{
			cold = 100;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "*dotkniecie symbolu na rekojesci powoduje wskrzeszenie czlowieka lub zwierzecia*");
        }
