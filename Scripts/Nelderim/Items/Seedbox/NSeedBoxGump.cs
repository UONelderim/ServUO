...
using SeedBox = Server.Items.SeedBox;
...
namespace Server.Gumps
{
	public class NSeedBoxGump : Gump
	{
		...
		{
			0xC83, 0xC86, 0xC88, 0xC94, 0xC8B, 0xCA5, 0xCA7, 0xC97, 0xC9F, 0xCA6, 0xC9C, 0xD31, 0xD04, 0xCA9, 0xD2C,
			0xD26, 0xD27
		};

		private static readonly int[] m_Labels =
		{
			1023203, 1023206, 1023208, 1023220, 1023211, 1023237, 1023239, 1023223, 1023231, 1023238, 1023225,
			1023376, 1023332, 1023241, 1023372, 1023366, 1023367
		};

		private static string[] m_Strings =
		{
			"Campion Flowers", "Poppies", "Snowdrops", "Bulrushes", "Lilies", "Pampas Grass", "Rushes",
			"Elephant Ear Plant", "Fern", "Ponytail Palm", "Small Palm", "Century Plant", "Water Plant",
			"Snake Plant", "Prickley Pear Cactus", "Barrel Cactus", "Tribarrel Cactus"
		};
		...
		private static readonly int[] m_Buttons =
		{
			18, 19, 26, 27, 21, 24, 22, 25, 20, 23, 28, 30, 29, 31, 32, 33, 34, 35, 36
		};

		public Mobile Owner { get; set; }

		public NSeedBoxGump(Mobile owner, SeedBox box) : this(owner, box, 0)
		{
		}

		public NSeedBoxGump(Mobile owner, SeedBox box, int PlantId) : base(10, 10)
		{
...
/*			AddBackground( gumpX, gumpY, 476, 400, 0x53 );
			...
			if (m_box.m_counts[m_id, 18] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 355, m_box.m_counts[m_id, 18] + " Bezbarwne");
			}
			else
			...
			if (m_box.m_counts[m_id, 14] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 316, m_box.m_counts[m_id, 14] + " Rzadkie Karmazynowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 15] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 30, m_box.m_counts[m_id, 15] + " Rzadkie Rozowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 17] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 86, m_box.m_counts[m_id, 17] + " Rzadkie Wodne");
			}
			else
			...
			if (m_box.m_counts[m_id, 16] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 43, m_box.m_counts[m_id, 16] + " Rzadkie Ognistoczerowne");
			}
			else
			...
			if (m_box.m_counts[m_id, 2] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 36, m_box.m_counts[m_id, 2] + " Czerwone");
			}
			else
			...
			if (m_box.m_counts[m_id, 3] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 38, m_box.m_counts[m_id, 3] + " Jasno Czerwone");
			}
			else
			...
			if (m_box.m_counts[m_id, 10] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 41, m_box.m_counts[m_id, 10] + " Pomaranczowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 11] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 42, m_box.m_counts[m_id, 11] + " Jasno Pomaranczowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 8] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 251, m_box.m_counts[m_id, 8] + " Zolte");
			}
			else
			...
			if (m_box.m_counts[m_id, 9] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 153, m_box.m_counts[m_id, 9] + " Jasno Zolte");
			}
			else
			...
			if (m_box.m_counts[m_id, 4] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 61, m_box.m_counts[m_id, 4] + " Zielone");
			}
			else
			...
			if (m_box.m_counts[m_id, 5] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 163, m_box.m_counts[m_id, 5] + " Jasno Zielone");
			}
			else
			...
			if (m_box.m_counts[m_id, 6] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 102, m_box.m_counts[m_id, 6] + " Niebieskie");
			}
			else
			...
			if (m_box.m_counts[m_id, 7] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 104, m_box.m_counts[m_id, 7] + " Jasno Niebieskie");
			}
			else
			...
			if (m_box.m_counts[m_id, 12] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 17, m_box.m_counts[m_id, 12] + " Fioletowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 13] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 19, m_box.m_counts[m_id, 13] + " Jasno Fioletowe");
			}
			else
			...
			if (m_box.m_counts[m_id, 0] > 0)
			{
				...
				AddLabel(lab1, gumpY + 3, 0, m_box.m_counts[m_id, 0] + " Czarne");
			}
			else
			...
			if (m_box.m_counts[m_id, 1] > 0)
			{
				...
				AddLabel(lab2, gumpY + 3, 2100, m_box.m_counts[m_id, 1] + " Biale");
			}
			else
