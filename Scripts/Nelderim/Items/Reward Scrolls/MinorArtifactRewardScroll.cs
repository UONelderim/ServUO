...
namespace Server.Items
{
    public class MinorArtifactRewardScroll : ArtifactRewardScroll {
        ...
        {
            " Gold Bricks ", " Phillip's Wooden Steed ",
            " Alchemist's Bauble ", " Arctic Death Dealer ",
            " Blaze Of Death ", " Bow Of The Juka King ",
            " Burglar's Bandana ", " Cavorting Club ",
            " Enchanted Titan Leg Bone ", " Gwenno's Harp ",
            " Iolo's Lute ", " Luna Lance ",
            " Night's Kiss ", " Nox Rangers Heavy Crossbow ",
            " Orcish Visage ", " Polar Bear Mask ",
            " Shield Of Invulnerability ", " Staff Of Power ",
            " Violet Courage ", " Heart Of The Lion ",
            " Wrath Of The Dryad ", " Pixie Swatter ",
        ...
        public override string RewardScrollInfo { get { return "Zwoj Mniejszego Artefaktu";} }
        public override string RewardInfo { get { return "Pomniejszy Arefakt";} }
