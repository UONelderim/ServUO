...
namespace Server.Items
{
	public class RunicDeed : Item
	{
		...
		[Constructable]
		public RunicDeed(string name)
			: base(0x14F0)
		{
			Name = "zwoj runicznych narzedzi";
			LootType = LootType.Blessed;
			Hue = 1169;
		}

		public RunicDeed(Serial serial)
			: base(serial)
		{
		}
	...
	public class RunicBag : Bag
	{
		...
		public RunicBag(int amount)
		{
			...
			DropItem(new RunicHammer(CraftResource.Valorite, 10000));


			DropItem(new RunicSewingKit(CraftResource.BarbedLeather, 10000));
	...
	public class RunicGump : Gump
	{
		...
		public RunicGump(Mobile from, Item deed)
			: base(30, 20)
		{
			m_Mobile = from;
			m_Deed = deed;
