...
namespace Server
{
	public class SkillNewCharPickGump : Gump
	{
        ...
        private SkillBallNewChar  m_SkillBall;
        ...
        private static SkillIdName[] SkillNames = new SkillIdName[] {
            new SkillIdName(SkillName.Alchemy,	"Alchemia"),
            new SkillIdName(SkillName.Anatomy,	"Anatomia"),
            new SkillIdName(SkillName.AnimalLore,	"Wiedza o zwierzetach"),
            new SkillIdName(SkillName.ItemID,	"Identyfikacja"),
            new SkillIdName(SkillName.ArmsLore,	"Wiedza o broni"),
            new SkillIdName(SkillName.Parry,	"Parowanie"),
            new SkillIdName(SkillName.Begging,	"Zebranie"),   // ?
            new SkillIdName(SkillName.Blacksmith,	"Kowalstwo"),
            new SkillIdName(SkillName.Fletching,	"Wyrabianie lukow"),
            new SkillIdName(SkillName.Peacemaking,	"Uspokajanie"),
            new SkillIdName(SkillName.Camping,	"Obozowanie"),
            new SkillIdName(SkillName.Carpentry,	"Stolarstwo"),
            new SkillIdName(SkillName.Cartography,	"Kartografia"),
            new SkillIdName(SkillName.Cooking,	"Gotowanie"),
            new SkillIdName(SkillName.DetectHidden,	"Wykrywanie"),
            new SkillIdName(SkillName.Discordance,	"Dezorientacja"),
            new SkillIdName(SkillName.EvalInt,	"Madrosc"),
            new SkillIdName(SkillName.Healing,	"Leczenie"),
            new SkillIdName(SkillName.Fishing,	"Rybactwo"),
            new SkillIdName(SkillName.Herbalism,	"Zielarstwo"),
            new SkillIdName(SkillName.Herding,	"Pasterstwo"),
            new SkillIdName(SkillName.Hiding,	"Ukrywanie"),
            new SkillIdName(SkillName.Provocation,	"Prowokacja"),
            new SkillIdName(SkillName.Inscribe,	"Inskrypcja"),
            new SkillIdName(SkillName.Lockpicking,	"Wlamywanie"),
            new SkillIdName(SkillName.Magery,	"Magia"),
            new SkillIdName(SkillName.MagicResist,	"Odpornosc na magie"),
            new SkillIdName(SkillName.Tactics,	"Taktyka"),
            new SkillIdName(SkillName.Snooping,	"Zagladanie"),
            new SkillIdName(SkillName.Musicianship,	"Kunszt muzyczny"),
            new SkillIdName(SkillName.Poisoning,	"Zatruwanie"),
            new SkillIdName(SkillName.Archery,	"Lucznictwo"),
            new SkillIdName(SkillName.SpiritSpeak,	"Rozmowa z duchami"),
            new SkillIdName(SkillName.Stealing,	"Okradanie"),
            new SkillIdName(SkillName.Tailoring,	"Krawiectwo"),
            new SkillIdName(SkillName.AnimalTaming,	"Oswajanie"),
            new SkillIdName(SkillName.TasteID,	"Ocena smaku"),   // ?
            new SkillIdName(SkillName.Tinkering,	"Majsterkowanie"),
            new SkillIdName(SkillName.Tracking,	"Tropienie"),
            new SkillIdName(SkillName.Veterinary,	"Weterynaria"),
            new SkillIdName(SkillName.Swords,	"Walka mieczami"),
            new SkillIdName(SkillName.Macing,	"Walka obuchami"),
            new SkillIdName(SkillName.Fencing,	"Walka szpadami"),
            new SkillIdName(SkillName.Wrestling,	"Walka piesciami"),
            new SkillIdName(SkillName.Lumberjacking,	"Drwalstwo"),
            new SkillIdName(SkillName.Mining,	"Gornictwo"),
            ...
            new SkillIdName(SkillName.Chivalry,	"Rycerstwo"),
            new SkillIdName(SkillName.Bushido,	"Tradycja wojenna"),
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case 1:
				{
					...
					{
						m.SendGump( new SkillNewCharPickGump(m_SkillBall) );
						m.SendMessage( 0, "Musisz odznaczyc {0} umiejetnosci. Maksymalna ilosc wynosi {1}.", info.Switches.Length - switches, switches);
						break;                     
                    }
                    else
                    {
	...
	{ 
        ...
        private Mobile m_Character;

        [CommandProperty( AccessLevel.GameMaster )]
        public Mobile BondedCharacter
        {
