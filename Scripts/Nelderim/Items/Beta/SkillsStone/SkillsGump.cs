...
namespace Server.Gumps
{
    public class PvPEditSkillGump : Gump
    {
        ...
        private double m_SkillsToUse;

        private PvPSkillsGumpGroup m_Selected;
        ...
        public double SkillsToUse
        {
            get
            {
                return m_SkillsToUse;
            }
            set
            {
                m_SkillsToUse = value;
            ...
            if ( info.ButtonID == 1 )
            {
                try
                {
                    ...
                    if ( text != null )
                    {
                        ...
                        if ( SkillsTotal <= SkillsCap && (SkillAmount <= SkillsToUse + m_Skill.Base || SkillAmount <= m_Skill.Base) )
                        {
    ...
    public class PvPSkillsGump : Gump
    {
        ...
        private PvPSkillsGumpGroup[] m_Groups;
        private PvPSkillsGumpGroup m_Selected;
    ...
    public class PvPSkillsGumpGroup
    {
        ...
        private static PvPSkillsGumpGroup[] m_Groups = new PvPSkillsGumpGroup[] { new PvPSkillsGumpGroup( "Crafting", new SkillName[] { SkillName.Alchemy, SkillName.Blacksmith, SkillName.Cartography, SkillName.Carpentry, SkillName.Cooking, SkillName.Fletching, SkillName.Inscribe, SkillName.Tailoring, SkillName.Tinkering } ), new PvPSkillsGumpGroup( "Bardic", new SkillName[] { SkillName.Discordance, SkillName.Musicianship, SkillName.Peacemaking, SkillName.Provocation } ), new PvPSkillsGumpGroup( "Magical", new SkillName[] { SkillName.Chivalry, SkillName.EvalInt, SkillName.Magery, SkillName.MagicResist, SkillName.Meditation, SkillName.Necromancy, SkillName.SpiritSpeak, SkillName.Ninjitsu, SkillName.Bushido } ), new PvPSkillsGumpGroup( "Miscellaneous", new SkillName[] { SkillName.Camping, SkillName.Fishing, SkillName.Focus, SkillName.Healing, SkillName.Herding, SkillName.Lockpicking, SkillName.Lumberjacking, SkillName.Mining, SkillName.Snooping, SkillName.Veterinary } ), new PvPSkillsGumpGroup( "Combat Ratings", new SkillName[] { SkillName.Archery, SkillName.Fencing, SkillName.Macing, SkillName.Parry, SkillName.Swords, SkillName.Tactics, SkillName.Wrestling } ), new PvPSkillsGumpGroup( "Actions", new SkillName[] { SkillName.AnimalTaming, SkillName.Begging, SkillName.DetectHidden, SkillName.Hiding, SkillName.RemoveTrap, SkillName.Poisoning, SkillName.Stealing, SkillName.Stealth, SkillName.Tracking } ), new PvPSkillsGumpGroup( "Lore & Knowledge", new SkillName[] { SkillName.Anatomy, SkillName.AnimalLore, SkillName.ArmsLore, SkillName.Herbalism, SkillName.ItemID, SkillName.TasteID } ) };

        public static PvPSkillsGumpGroup[] Groups
        {
            get
            {
                return m_Groups;
