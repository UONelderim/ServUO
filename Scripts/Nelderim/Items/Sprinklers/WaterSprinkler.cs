...
namespace Server.Items
{
		...
		public override bool OnDragDrop(Mobile from, Item item)
		{
			...
			if (item is SprinklerContainer)
			{
				...
				if (keg.Quantity <= freespace)
				{
					...
					from.SendMessage(
						"Wkladasz pusty pojemnik do plecaka."); // You place the empty bottle in your backpack.
				...
				from.SendMessage(
					"To chyba nie jest woda?!"); // You don't have room for the empty bottle in your backpack.
				return false;
			}
	...
	public class SprinklerContainer : BaseBeverage
	{
		...
		{
			private readonly SprinklerContainer m_cont;
