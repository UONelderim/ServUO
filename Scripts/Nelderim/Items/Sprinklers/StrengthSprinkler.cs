...
namespace Server.Items
{
	public class StrengthSprinkler : Item, ISecurable, IUsesRemaining
	{
		...
		public override bool OnDragDrop(Mobile from, Item item)
		{
			...
			from.SendMessage(
				"Tego nie wsadzisz tutaj... Opamietaj sie!!"); // You don't have room for the empty bottle in your backpack.
			return false;
		}
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			writer.Write(this.m_StorageLimit);
		}
