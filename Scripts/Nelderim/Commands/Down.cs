...
namespace Server
{
	public class Down : Timer
	{
		...
		{
			CommandSystem.Register("Down", AccessLevel.Administrator, Down_OnCommand);
		}
		...
		{
			if (ShutDown || AutoRestart.Restarting || Restartb.Restarting || Downb.ShutDown || ResplanAlfa.Restarting ||
