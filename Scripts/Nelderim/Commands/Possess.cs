...
//LastUserValid	?
		public static void Initialize()
		{
			...
			CommandSystem.Register( "PossessRed", AccessLevel.Counselor, new CommandEventHandler( PossessRed_OnCommand ) );
			CommandSystem.Register( "PossessBlue", AccessLevel.Counselor, new CommandEventHandler( PossessBlue_OnCommand ) );
			CommandSystem.Register( "PossessGrey", AccessLevel.Counselor, new CommandEventHandler( PossessGrey_OnCommand ) );
		...
		private class PossessTarget : Target
		{
 			...
 			protected override void OnTarget( Mobile from_mob, object o )
			{
				...
				if (o is Mobile)
				{
					...
					int notoriety = NotorietyHandlers.MobileNotoriety( (Mobile)from, (Mobile)o );
					IMount mount;
		...
		private static void Possess_OnCommand( CommandEventArgs e )
		{
			...
			from.SendMessage(0x26, "Wroc do swojej postaci przed resatrtem lub wylaczeniem serwera, w przeciwnym razie pozostaniesz w niej na zawsze!");
