		...
		private static List<int> GetSongFromString(string data)
		{
			...
			while (matchResults.Success)
			{
				...
				switch (matchResults.Value.ToUpper())
				{
					//lute
					case "LC1":
						MusicalNotes.Add(LuteNotes.C1);
						break;
					case "LCS1":
						MusicalNotes.Add(LuteNotes.CS1);
						break;
					case "LD1":
						MusicalNotes.Add(LuteNotes.D1);
						break;
					case "LDS1":
						MusicalNotes.Add(LuteNotes.DS1);
						break;
					case "LE1":
						MusicalNotes.Add(LuteNotes.E1);
						break;
					case "LF1":
						MusicalNotes.Add(LuteNotes.F1);
						break;
					case "LFS1":
						MusicalNotes.Add(LuteNotes.FS1);
						break;
					case "LG1":
						MusicalNotes.Add(LuteNotes.G1);
						break;
					case "LGS1":
						MusicalNotes.Add(LuteNotes.GS1);
						break;
					case "LA1":
						MusicalNotes.Add(LuteNotes.A1);
						break;
					case "LAS1":
						MusicalNotes.Add(LuteNotes.AS1);
						break;
					case "LB1":
						MusicalNotes.Add(LuteNotes.B1);
						break;
					case "LC2":
						MusicalNotes.Add(LuteNotes.C2);
						break;
					case "LCS2":
						MusicalNotes.Add(LuteNotes.CS2);
						break;
					case "LD2":
						MusicalNotes.Add(LuteNotes.D2);
						break;
					case "LDS2":
						MusicalNotes.Add(LuteNotes.DS2);
						break;
					case "LE2":
						MusicalNotes.Add(LuteNotes.E2);
						break;
					case "LF2":
						MusicalNotes.Add(LuteNotes.F2);
						break;
					case "LFS2":
						MusicalNotes.Add(LuteNotes.FS2);
						break;
					case "LG2":
						MusicalNotes.Add(LuteNotes.G2);
						break;
					case "LGS2":
						MusicalNotes.Add(LuteNotes.GS2);
						break;
					case "LA2":
						MusicalNotes.Add(LuteNotes.A2);
						break;
					case "LAS2":
						MusicalNotes.Add(LuteNotes.AS2);
						break;
					case "LB2":
						MusicalNotes.Add(LuteNotes.B2);
						break;
					case "LC3":
						MusicalNotes.Add(LuteNotes.C3);
						break;
					//harp notes
					case "HC1":
						MusicalNotes.Add(LapHarpNotes.C1);
						break;
					case "HCS1":
						MusicalNotes.Add(LapHarpNotes.CS1);
						break;
					case "HD1":
						MusicalNotes.Add(LapHarpNotes.D1);
						break;
					case "HDS1":
						MusicalNotes.Add(LapHarpNotes.DS1);
						break;
					case "HE1":
						MusicalNotes.Add(LapHarpNotes.E1);
						break;
					case "HF1":
						MusicalNotes.Add(LapHarpNotes.F1);
						break;
					case "HFS1":
						MusicalNotes.Add(LapHarpNotes.FS1);
						break;
					case "HG1":
						MusicalNotes.Add(LapHarpNotes.G1);
						break;
					case "HGS1":
						MusicalNotes.Add(LapHarpNotes.GS1);
						break;
					case "HA1":
						MusicalNotes.Add(LapHarpNotes.A1);
						break;
					case "HAS1":
						MusicalNotes.Add(LapHarpNotes.AS1);
						break;
					case "HB1":
						MusicalNotes.Add(LapHarpNotes.B1);
						break;
					case "HC2":
						MusicalNotes.Add(LapHarpNotes.C2);
						break;
					case "HCS2":
						MusicalNotes.Add(LapHarpNotes.CS2);
						break;
					case "HD2":
						MusicalNotes.Add(LapHarpNotes.D2);
						break;
					case "HDS2":
						MusicalNotes.Add(LapHarpNotes.DS2);
						break;
					case "HE2":
						MusicalNotes.Add(LapHarpNotes.E2);
						break;
					case "HF2":
						MusicalNotes.Add(LapHarpNotes.F2);
						break;
					case "HFS2":
						MusicalNotes.Add(LapHarpNotes.FS2);
						break;
					case "HG2":
						MusicalNotes.Add(LapHarpNotes.G2);
						break;
					case "HGS2":
						MusicalNotes.Add(LapHarpNotes.GS2);
						break;
					case "HA2":
						MusicalNotes.Add(LapHarpNotes.A2);
						break;
					case "HAS2":
						MusicalNotes.Add(LapHarpNotes.AS2);
						break;
					case "HB2":
						MusicalNotes.Add(LapHarpNotes.B2);
						break;
					case "HC3":
						MusicalNotes.Add(LapHarpNotes.C3);
						break;
					//stand harp notes
					//M just mean, music I guess?
					case "MC1":
						MusicalNotes.Add(StandHarpNotes.C1);
						break;
					case "MCS1":
						MusicalNotes.Add(StandHarpNotes.CS1);
						break;
					case "MD1":
						MusicalNotes.Add(StandHarpNotes.D1);
						break;
					case "MDS1":
						MusicalNotes.Add(StandHarpNotes.DS1);
						break;
					case "ME1":
						MusicalNotes.Add(StandHarpNotes.E1);
						break;
					case "MF1":
						MusicalNotes.Add(StandHarpNotes.F1);
						break;
					case "MFS1":
						MusicalNotes.Add(StandHarpNotes.FS1);
						break;
					case "MG1":
						MusicalNotes.Add(StandHarpNotes.G1);
						break;
					case "MGS1":
						MusicalNotes.Add(StandHarpNotes.GS1);
						break;
					case "MA1":
						MusicalNotes.Add(StandHarpNotes.A1);
						break;
					case "MAS1":
						MusicalNotes.Add(StandHarpNotes.AS1);
						break;
					case "MB1":
						MusicalNotes.Add(StandHarpNotes.B1);
						break;
					case "MC2":
						MusicalNotes.Add(StandHarpNotes.C2);
						break;
					case "MCS2":
						MusicalNotes.Add(StandHarpNotes.CS2);
						break;
					case "MD2":
						MusicalNotes.Add(StandHarpNotes.D2);
						break;
					case "MDS2":
						MusicalNotes.Add(StandHarpNotes.DS2);
						break;
					case "ME2":
						MusicalNotes.Add(StandHarpNotes.E2);
						break;
					case "MF2":
						MusicalNotes.Add(StandHarpNotes.F2);
						break;
					case "MFS2":
						MusicalNotes.Add(StandHarpNotes.FS2);
						break;
					case "MG2":
						MusicalNotes.Add(StandHarpNotes.G2);
						break;
					case "MGS2":
						MusicalNotes.Add(StandHarpNotes.GS2);
						break;
					case "MA2":
						MusicalNotes.Add(StandHarpNotes.A2);
						break;
					case "MAS2":
						MusicalNotes.Add(StandHarpNotes.AS2);
						break;
					case "MB2":
						MusicalNotes.Add(StandHarpNotes.B2);
						break;
					case "MC3":
						MusicalNotes.Add(StandHarpNotes.C3);
						break;
					//special case if a break in music
					case "-":
						MusicalNotes.Add(0x0);
						break;
				}
			...
			TimerCallback callback = delegate
			{
				if (MusicalNotes != null && sendMusicTo != null && sendMusicTo.Player)
				{
					...
					if (MusicalNotes.Count > 1)
					{
						...
						if (MusicalNotes[0] != 0)
						{
							sendMusicTo.PlaySound(MusicalNotes[0]);
						}
