...
namespace Server.Helpers
{
	...
	public class DefaultValue<T>
	{
		...
		public T this[Type type]
		{
			...
			{
				if (type == null)
					throw new ArgumentNullException(String.Format("Proba odczytu z Default.{0} z indexem == null.",
						typeof(T).Name));
				...
				throw new ArgumentOutOfRangeException(String.Format("Typ {0} nie dziedziczy po {1}.", type.Name,
					typeof(T).Name));
			}
		}
