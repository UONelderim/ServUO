    ...
    public class SBTinker : SBInfo
    {
        ...
        public class InternalBuyInfo : List<IBuyItemInfo>
        {
            public InternalBuyInfo(BaseVendor owner)
            {
                ...
                Add( new GenericBuyInfo( typeof( PowderForTinkering ), 50000, 20, 4102, 0 ) );

                Add(new GenericBuyInfo(typeof(TinkerTools), 30, 50, 0x1EB8, 0));
                ...
                Add(new GenericBuyInfo(typeof(ButcherKnife), 30, 50, 0x13F6, 0));

                Add(new GenericBuyInfo(typeof(Scissors), 11, 50, 0xF9F, 0));

                Add(new GenericBuyInfo(typeof(Tongs), 30, 50, 0xFBB, 0));
