    ...
    public class SBJewel : SBInfo
    {
        ...
        public class InternalBuyInfo : List<IBuyItemInfo>
        {
            public InternalBuyInfo()
            {
				...
				Add( new GenericBuyInfo( typeof( Beads ), 27, 50, 0x108B, 0 ) );
				Add( new GenericBuyInfo( typeof( GoldBracelet ), 27, 50, 0x1086, 0 ) );
				Add( new GenericBuyInfo( typeof( GoldEarrings ), 27, 50, 0x1087, 0 ) );

				Add( new GenericBuyInfo( "1060740", typeof( BroadcastCrystal ),  68, 50, 0x1ED0, 0, new object[] {  500 } ) ); // 500 charges
				Add( new GenericBuyInfo( "1060740", typeof( BroadcastCrystal ), 131, 50, 0x1ED0, 0, new object[] { 1000 } ) ); // 1000 charges
				Add( new GenericBuyInfo( "1060740", typeof( BroadcastCrystal ), 256, 50, 0x1ED0, 0, new object[] { 2000 } ) ); // 2000 charges

				Add( new GenericBuyInfo( "1060740", typeof( ReceiverCrystal ), 6, 50, 0x1ED0, 0 ) );

				Add( new GenericBuyInfo( typeof( StarSapphire ), 200, 50, 0xF21, 0 ) );
				Add( new GenericBuyInfo( typeof( Emerald ), 140, 50, 0xF10, 0 ) );
				Add( new GenericBuyInfo( typeof( Sapphire ), 150, 50, 0xF19, 0 ) );
				Add( new GenericBuyInfo( typeof( Ruby ), 140, 50, 0xF13, 0 ) );
				Add( new GenericBuyInfo( typeof( Citrine ), 100, 50, 0xF15, 0 ) );
				Add( new GenericBuyInfo( typeof( Amethyst ), 100, 50, 0xF16, 0 ) );
				Add( new GenericBuyInfo( typeof( Tourmaline ), 80, 50, 0xF2D, 0 ) );
				Add( new GenericBuyInfo( typeof( Amber ), 50, 50, 0xF25, 0 ) );
				Add( new GenericBuyInfo( typeof( Diamond ), 300, 50, 0xF26, 0 ) );
            }
        }
