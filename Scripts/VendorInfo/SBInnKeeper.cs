    ...
    public class SBInnKeeper : SBInfo
    {
        ...
        public class InternalBuyInfo : List<IBuyItemInfo>
        {
            public InternalBuyInfo()
            {
				...
				Add( new GenericBuyInfo( typeof( ChickenLeg ), 6, 50, 0x1608, 0 ) );
				Add( new GenericBuyInfo( typeof( Ribs ), 18, 50, 0x9F2, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( Banana ), 2, 50, 0x171F, 0 ) );
				Add( new GenericBuyInfo( typeof( Torch ), 7, 50, 0xF6B, 0 ) );
