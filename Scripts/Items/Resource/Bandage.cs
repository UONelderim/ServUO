        ...
        public static BandageContext BeginHeal(Mobile healer, Mobile patient, bool enhanced)
        {
            ...
            else if (healer.CanBeBeneficial(patient, true, true))
            {
                ...
                if (patient is PlayerMobile)
                    BuffInfo.AddBuff(healer, new BuffInfo(BuffIcon.Healing, 1002082, 1151400, delay + TimeSpan.FromMilliseconds(100), healer, string.Format("{0}", patient.Name)));
                else
                    BuffInfo.AddBuff(healer, new BuffInfo(BuffIcon.Veterinary, 1002167, 1151400, delay + TimeSpan.FromMilliseconds(100), healer, string.Format("{0}", patient.Name)));
