...
namespace Server.Items
{
    ...
    public class ScrollOfTranscendenceBook : BaseSpecialScrollBook
    {
        ...
        public static void Initialize()
        {
            ...
            _SkillInfo[SkillCat.Miscellaneous] = new List<SkillName>() { SkillName.ArmsLore, SkillName.Begging, SkillName.Camping, SkillName.Cartography, /*SkillName.Forensics, */SkillName.ItemID, SkillName.TasteID }; //!NELDERIM!
