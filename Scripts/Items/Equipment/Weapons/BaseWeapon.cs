        ...
        */
        ...
        public virtual bool CheckHit(Mobile attacker, IDamageable damageable)
        {
            ...
            if (atkWeapon is BaseThrown)
            {
                ...
                {
                    chance -= (.12 - Math.Min(12, (attacker.Skills[SkillName.Throwing].Value + attacker.RawDex) / 20) / 100);
                }
        ...
        public virtual void OnHit(Mobile attacker, IDamageable damageable, double damageBonus)
        {
            ...
            */
            ...
            if (manaLeech != 0)
            {
                attacker.Mana += Utility.RandomMinMax(0, (int)(AOS.Scale(damageGiven, manaLeech) * 0.8));
            }
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            int oreType = CraftResources.GetNameSuffixNumber(m_Resource);
