...
namespace Server.Misc
{
    public class Aggression
    {
        ...
        public static void EventSink_AggressiveAction(AggressiveActionEventArgs e)
        {
            ...
            {
                aggressor.LocalOverheadMessage(MessageType.Regular, Hue, true, String.Format(AggressorFormat, aggressed.NGetName(aggressor)));
                aggressed.LocalOverheadMessage(MessageType.Regular, Hue, true, String.Format(AggressedFormat, aggressor.NGetName(aggressed)));
            }
